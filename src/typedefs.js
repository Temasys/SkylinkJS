 ...
 * @property {boolean} [enableIceTrickle=true] The flag if Peer connections should
 ...
 * @property {boolean} [usePublicSTUN=false] The flag if publicly available STUN ICE servers should
 *   be used if <code>enableSTUNServer</code> is enabled.
 ...
 *   Note that the mininum timeout value is <code>5000</code>. If less, this value will be <code>5000</code>.
 ...
 *   <code>mcuUseRenegoRestart</code> being set to <code>false</code>.
 ...
 * @property {boolean} [mcuUseRenegoRestart=false] <blockquote class="info">
 ...
 *   The flag if {@link Skylink#refreshConnection} should renegotiate like non-MCU enabled Peer connection for MCU
 *   enabled Peer connections instead of invoking {@link Skylink#joinRoom} again.
 ...
 * @property {String} [priorityWeightScheme] <blockquote class="info">
 ...
 * @property {boolean} [useEdgeWebRTC=false] The flag to use Edge 15.x pre-1.0 WebRTC support.
 * @property {boolean} [enableSimultaneousTransfers=true] The flag to enable simultaneous data transfers.
 ...
 *   Note this would cause {@link SkylinkEvents.event:peerRestart|peerRestartEvent} to be triggered
 ...
 * @property {boolean} config.enableIceTrickle The flag if Peer connection has
 ...
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {JSON} statistics.selectedCandidate The Peer connection selected ICE candidate pair statistics.
 * @property {JSON} statistics.selectedCandidate.local The Peer connection selected local ICE candidate.
 * @property {String} statistics.selectedCandidate.local.ipAddress The Peer connection selected
 *   local ICE candidate IP address.
 * @property {Number} statistics.selectedCandidate.local.portNumber The Peer connection selected
 *   local ICE candidate port number.
 * @property {String} statistics.selectedCandidate.local.transport The Peer connection selected
 *   local ICE candidate IP transport type.
 * @property {String} statistics.selectedCandidate.local.candidateType The Peer connection selected
 *   local ICE candidate type.
 * @property {String} [statistics.selectedCandidate.local.turnMediaTransport] - The Peer connection possible
 ...
 * @property {JSON} statistics.selectedCandidate.remote The Peer connection selected remote ICE candidate.
 * @property {String} statistics.selectedCandidate.remote.ipAddress The Peer connection selected
 *   remote ICE candidate IP address.
 * @property {Number} statistics.selectedCandidate.remote.portNumber The Peer connection selected
 *   remote ICE candidate port number.
 * @property {String} statistics.selectedCandidate.remote.transport The Peer connection selected
 *   remote ICE candidate IP transport type.
 * @property {String} statistics.selectedCandidate.remote.candidateType The Peer connection selected
 *   remote ICE candidate type.
 * @property {boolean} [statistics.selectedCandidate.writable] - The flag if Peer has gotten ACK to an ICE request.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {boolean} [statistics.selectedCandidate.readable] - The flag if Peer has gotten a valid incoming ICE request.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.rtt] - The current STUN connectivity checks RTT (Round-trip delay time).
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.totalRtt] - The total STUN connectivity checks RTT (Round-trip delay time).
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {JSON} statistics.selectedCandidate.requests The ICE connectivity check requests.
 * @property {String} [statistics.selectedCandidate.requests.received] - The current ICE connectivity check requests received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.requests.sent] - The current ICE connectivity check requests sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.requests.totalReceived] - The total ICE connectivity check requests received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.requests.totalSent] - The total ICE connectivity check requests sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {JSON} statistics.selectedCandidate.responses The ICE connectivity check responses.
 * @property {String} [statistics.selectedCandidate.responses.received] - The current ICE connectivity check responses received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.responses.sent] - The current ICE connectivity check responses sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.responses.totalReceived] - The total ICE connectivity check responses received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.responses.totalSent] - The total ICE connectivity check responses sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {JSON} statistics.selectedCandidate.consentRequests The current ICE consent requests.
 * @property {String} [statistics.selectedCandidate.consentRequests.received] - The current ICE consent requests received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentRequests.sent] - The current ICE consent requests sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentRequests.totalReceived] - The total ICE consent requests received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentRequests.totalSent] - The total ICE consent requests sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {JSON} statistics.selectedCandidate.consentResponses The current ICE consent responses.
 * @property {String} [statistics.selectedCandidate.consentResponses.received] - The current ICE consent responses received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentResponses.sent] - The current ICE consent responses sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentResponses.totalReceived] - The total ICE consent responses received.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
 * @property {String} [statistics.selectedCandidate.consentResponses.totalSent] - The total ICE consent responses sent.
 *   Defined as <code>null</code> if it's not available in original raw statistics.before parsing.
