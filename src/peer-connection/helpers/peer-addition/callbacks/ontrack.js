...
import MediaStreamCl from '../../../../media-stream/index';
...
const ontrack = (RTCPeerConnection, targetMid, currentRoomState, rtcTrackEvent) => {
  ...
  MediaStreamCl.updateRemoteStreams(state.room, peerId, stream);
  MediaStreamCl.onRemoteTrackAdded(stream, currentRoomState, peerId, isScreensharing, track.kind === TRACK_KIND.VIDEO, track.kind === TRACK_KIND.AUDIO);
