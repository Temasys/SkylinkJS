export const INCOMING_STREAM = 'onIncomingStream';
export const INCOMING_SCREEN_STREAM = 'onIncomingScreenStream';
...
export const PEER_RESTART = 'peerRestart';
...
export const SERVER_PEER_RESTART = 'serverPeerRestart';
