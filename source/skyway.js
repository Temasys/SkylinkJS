...
(function() {
  /**
   * If call Skyway as an empty constructor, you may call
   * {{#crossLink "Skyway/init:method"}}init(){{/crossLink}} later to initialize Skyway.
   * @class Skyway
   * @constructor
   ...
   *  // Example 1: Calling init after calling Skyway as an empty constructor
   *   var SkywayDemo = new Skyway();
   *   // .... after all checks and stuff
   *   SkywayDemo.init('apiKey');
   *
   *   // Example 2: Initializing Skyway
   *   var SkywayDemo = new Skyway('apiKey');
   *
   *   // Example 3: To initialize with apikey, roomServer and defaultRoom
   *   var SkywayDemo = new Skyway({
   *     'apiKey' : 'apiKey',
   ...
   *   });
   *
   *   // Example 4: To initialize with credentials to set startDateTime and
