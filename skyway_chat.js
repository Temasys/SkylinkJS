...
(function () {
  ...
  Skyway.prototype._events = {
    ...
    */
     ...
     * @param {String} senderID Sender peer
     * @param {String} targetPeerID Targeted Peer to receive the data
     * @param {Boolean} isSelf Is Sent from self
     */
    'privateMessage' : [],
    /**
   ...
   * @param {Boolean} useDataChannel Option to allow Users to send 
   *   their chat via DataChannel
   */
  Skyway.prototype.sendChatMsg = function (chatMsg, targetPeerID, useDataChannel) {
    ...
    this._trigger('chatMessage', chatMsg, this._user.displayName, !!targetPeerID);
  };
  ...
  Skyway.prototype._chatHandler = function (msg) {
    this._trigger('chatMessage', msg.data, msg.senderID),
      (msg.target ? true : false), (msg.senderID === this._user.id));
  };
  ...
  Skyway.prototype._privateMsgHandler = function (msg) {
    this._trigger('privateMessage', msg.data, this._user.id, 
      msg.target, false);
  };
  ...
  Skyway.prototype._publicMsgHandler = function (msg) {
    this._trigger('publicMessage', msg.data, this._user.id, false);
  };
  ...
  Skyway.prototype._processDcChat = function ( dc, dataStr ) {
    ...
    var msg = { type: 'chat', mid: msgMid, data: chatDisplay };
