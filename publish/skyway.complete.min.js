...
},BinaryReconstructor.prototype.takeBinaryData=function(binData){if(this.buffers.push(binData),this.buffers.length==this.reconPack.attachments){var packet=binary.reconstructPacket(this.reconPack,this.buffers);return this.finishedReconstruction(),packet}return null},BinaryReconstructor.prototype.finishedReconstruction=function(){this.reconPack=null,this.buffers=[]}},{"./binary":39,debug:9,emitter:10,isarray:41,json3:42}],41:[function(require,module){module.exports=require(33)},{}],42:[function(require,module,exports){!function(window){function has(name){if(has[name]!==undef)return has[name];var isSupported;if("bug-string-char-index"==name)isSupported="a"!="a"[0];else if("json"==name)isSupported=has("json-stringify")&&has("json-parse");else{var value,serialized='{"a":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}';if("json-stringify"==name){var stringify=JSON3.stringify,stringifySupported="function"==typeof stringify&&isExtended;if(stringifySupported){(value=function(){return 1}).toJSON=value;try{stringifySupported="0"===stringify(0)&&"0"===stringify(new Number)&&'""'==stringify(new String)&&stringify(getClass)===undef&&stringify(undef)===undef&&stringify()===undef&&"1"===stringify(value)&&"[1]"==stringify([value])&&"[null]"==stringify([undef])&&"null"==stringify(null)&&"[null,null,null]"==stringify([undef,getClass,null])&&stringify({a:[value,!0,!1,null,"\x00\b\n\f\r	"]})==serialized&&"1"===stringify(null,value)&&"[\n 1,\n 2\n]"==stringify([1,2],null,1)&&'"-271821-04-20T00:00:00.000Z"'==stringify(new Date(-864e13))&&'"+275760-09-13T00:00:00.000Z"'==stringify(new Date(864e13))&&'"-000001-01-01T00:00:00.000Z"'==stringify(new Date(-621987552e5))&&'"1969-12-31T23:59:59.999Z"'==stringify(new Date(-1))}catch(exception){stringifySupported=!1}}isSupported=stringifySupported}if("json-parse"==name){var parse=JSON3.parse;if("function"==typeof parse)try{if(0===parse("0")&&!parse(!1)){value=parse(serialized);var parseSupported=5==value.a.length&&1===value.a[0];if(parseSupported){try{parseSupported=!parse('"	"')}catch(exception){}if(parseSupported)try{parseSupported=1!==parse("01")}catch(exception){}if(parseSupported)try{parseSupported=1!==parse("1.")}catch(exception){}}}}catch(exception){parseSupported=!1}isSupported=parseSupported}}return has[name]=!!isSupported}var isProperty,forEach,undef,getClass={}.toString,isLoader="function"==typeof define&&define.amd,nativeJSON="object"==typeof JSON&&JSON,JSON3="object"==typeof exports&&exports&&!exports.nodeType&&exports;JSON3&&nativeJSON?(JSON3.stringify=nativeJSON.stringify,JSON3.parse=nativeJSON.parse):JSON3=window.JSON=nativeJSON||{};var isExtended=new Date(-0xc782b5b800cec);try{isExtended=-109252==isExtended.getUTCFullYear()&&0===isExtended.getUTCMonth()&&1===isExtended.getUTCDate()&&10==isExtended.getUTCHours()&&37==isExtended.getUTCMinutes()&&6==isExtended.getUTCSeconds()&&708==isExtended.getUTCMilliseconds()}catch(exception){}if(!has("json")){var functionClass="[object Function]",dateClass="[object Date]",numberClass="[object Number]",stringClass="[object String]",arrayClass="[object Array]",booleanClass="[object Boolean]",charIndexBuggy=has("bug-string-char-index");if(!isExtended)var floor=Math.floor,Months=[0,31,59,90,120,151,181,212,243,273,304,334],getDay=function(year,month){return Months[month]+365*(year-1970)+floor((year-1969+(month=+(month>1)))/4)-floor((year-1901+month)/100)+floor((year-1601+month)/400)};(isProperty={}.hasOwnProperty)||(isProperty=function(property){var constructor,members={};return(members.__proto__=null,members.__proto__={toString:1},members).toString!=getClass?isProperty=function(property){var original=this.__proto__,result=property in(this.__proto__=null,this);return this.__proto__=original,result}:(constructor=members.constructor,isProperty=function(property){var parent=(this.constructor||constructor).prototype;return property in this&&!(property in parent&&this[property]===parent[property])}),members=null,isProperty.call(this,property)});var PrimitiveTypes={"boolean":1,number:1,string:1,undefined:1},isHostType=function(object,property){var type=typeof object[property];return"object"==type?!!object[property]:!PrimitiveTypes[type]};if(forEach=function(object,callback){var Properties,members,property,size=0;(Properties=function(){this.valueOf=0}).prototype.valueOf=0,members=new Properties;for(property in members)isProperty.call(members,property)&&size++;return Properties=members=null,size?forEach=2==size?function(object,callback){var property,members={},isFunction=getClass.call(object)==functionClass;for(property in object)isFunction&&"prototype"==property||isProperty.call(members,property)||!(members[property]=1)||!isProperty.call(object,property)||callback(property)}:function(object,callback){var property,isConstructor,isFunction=getClass.call(object)==functionClass;for(property in object)isFunction&&"prototype"==property||!isProperty.call(object,property)||(isConstructor="constructor"===property)||callback(property);(isConstructor||isProperty.call(object,property="constructor"))&&callback(property)}:(members=["valueOf","toString","toLocaleString","propertyIsEnumerable","isPrototypeOf","hasOwnProperty","constructor"],forEach=function(object,callback){var property,length,isFunction=getClass.call(object)==functionClass,hasProperty=!isFunction&&"function"!=typeof object.constructor&&isHostType(object,"hasOwnProperty")?object.hasOwnProperty:isProperty;for(property in object)isFunction&&"prototype"==property||!hasProperty.call(object,property)||callback(property);for(length=members.length;property=members[--length];hasProperty.call(object,property)&&callback(property));}),forEach(object,callback)},!has("json-stringify")){var Escapes={92:"\\\\",34:'\\"',8:"\\b",12:"\\f",10:"\\n",13:"\\r",9:"\\t"},leadingZeroes="000000",toPaddedString=function(width,value){return(leadingZeroes+(value||0)).slice(-width)},unicodePrefix="\\u00",quote=function(value){var symbols,result='"',index=0,length=value.length,isLarge=length>10&&charIndexBuggy;for(isLarge&&(symbols=value.split(""));length>index;index++){var charCode=value.charCodeAt(index);switch(charCode){case 8:case 9:case 10:case 12:case 13:case 34:case 92:result+=Escapes[charCode];break;default:if(32>charCode){result+=unicodePrefix+toPaddedString(2,charCode.toString(16));break}result+=isLarge?symbols[index]:charIndexBuggy?value.charAt(index):value[index]}}return result+'"'},serialize=function(property,object,callback,properties,whitespace,indentation,stack){var value,className,year,month,date,time,hours,minutes,seconds,milliseconds,results,element,index,length,prefix,result;try{value=object[property]}catch(exception){}if("object"==typeof value&&value)if(className=getClass.call(value),className!=dateClass||isProperty.call(value,"toJSON"))"function"==typeof value.toJSON&&(className!=numberClass&&className!=stringClass&&className!=arrayClass||isProperty.call(value,"toJSON"))&&(value=value.toJSON(property));else if(value>-1/0&&1/0>value){if(getDay){for(date=floor(value/864e5),year=floor(date/365.2425)+1970-1;getDay(year+1,0)<=date;year++);for(month=floor((date-getDay(year,0))/30.42);getDay(year,month+1)<=date;month++);date=1+date-getDay(year,month),time=(value%864e5+864e5)%864e5,hours=floor(time/36e5)%24,minutes=floor(time/6e4)%60,seconds=floor(time/1e3)%60,milliseconds=time%1e3}else year=value.getUTCFullYear(),month=value.getUTCMonth(),date=value.getUTCDate(),hours=value.getUTCHours(),minutes=value.getUTCMinutes(),seconds=value.getUTCSeconds(),milliseconds=value.getUTCMilliseconds();value=(0>=year||year>=1e4?(0>year?"-":"+")+toPaddedString(6,0>year?-year:year):toPaddedString(4,year))+"-"+toPaddedString(2,month+1)+"-"+toPaddedString(2,date)+"T"+toPaddedString(2,hours)+":"+toPaddedString(2,minutes)+":"+toPaddedString(2,seconds)+"."+toPaddedString(3,milliseconds)+"Z"}else value=null;if(callback&&(value=callback.call(object,property,value)),null===value)return"null";if(className=getClass.call(value),className==booleanClass)return""+value;if(className==numberClass)return value>-1/0&&1/0>value?""+value:"null";if(className==stringClass)return quote(""+value);if("object"==typeof value){for(length=stack.length;length--;)if(stack[length]===value)throw TypeError();if(stack.push(value),results=[],prefix=indentation,indentation+=whitespace,className==arrayClass){for(index=0,length=value.length;length>index;index++)element=serialize(index,value,callback,properties,whitespace,indentation,stack),results.push(element===undef?"null":element);result=results.length?whitespace?"[\n"+indentation+results.join(",\n"+indentation)+"\n"+prefix+"]":"["+results.join(",")+"]":"[]"}else forEach(properties||value,function(property){var element=serialize(property,value,callback,properties,whitespace,indentation,stack);element!==undef&&results.push(quote(property)+":"+(whitespace?" ":"")+element)}),result=results.length?whitespace?"{\n"+indentation+results.join(",\n"+indentation)+"\n"+prefix+"}":"{"+results.join(",")+"}":"{}";return stack.pop(),result}};JSON3.stringify=function(source,filter,width){var whitespace,callback,properties,className;if("function"==typeof filter||"object"==typeof filter&&filter)if((className=getClass.call(filter))==functionClass)callback=filter;else if(className==arrayClass){properties={};for(var value,index=0,length=filter.length;length>index;value=filter[index++],className=getClass.call(value),(className==stringClass||className==numberClass)&&(properties[value]=1));}if(width)if((className=getClass.call(width))==numberClass){if((width-=width%1)>0)for(whitespace="",width>10&&(width=10);whitespace.length<width;whitespace+=" ");}else className==stringClass&&(whitespace=width.length<=10?width:width.slice(0,10));return serialize("",(value={},value[""]=source,value),callback,properties,whitespace,"",[])}}if(!has("json-parse")){var Index,Source,fromCharCode=String.fromCharCode,Unescapes={92:"\\",34:'"',47:"/",98:"\b",116:"	",110:"\n",102:"\f",114:"\r"},abort=function(){throw Index=Source=null,SyntaxError()},lex=function(){for(var value,begin,position,isSigned,charCode,source=Source,length=source.length;length>Index;)switch(charCode=source.charCodeAt(Index)){case 9:case 10:case 13:case 32:Index++;break;case 123:case 125:case 91:case 93:case 58:case 44:return value=charIndexBuggy?source.charAt(Index):source[Index],Index++,value;case 34:for(value="@",Index++;length>Index;)if(charCode=source.charCodeAt(Index),32>charCode)abort();else if(92==charCode)switch(charCode=source.charCodeAt(++Index)){case 92:case 34:case 47:case 98:case 116:case 110:case 102:case 114:value+=Unescapes[charCode],Index++;break;case 117:for(begin=++Index,position=Index+4;position>Index;Index++)charCode=source.charCodeAt(Index),charCode>=48&&57>=charCode||charCode>=97&&102>=charCode||charCode>=65&&70>=charCode||abort();value+=fromCharCode("0x"+source.slice(begin,Index));break;default:abort()}else{if(34==charCode)break;for(charCode=source.charCodeAt(Index),begin=Index;charCode>=32&&92!=charCode&&34!=charCode;)charCode=source.charCodeAt(++Index);value+=source.slice(begin,Index)}if(34==source.charCodeAt(Index))return Index++,value;abort();default:if(begin=Index,45==charCode&&(isSigned=!0,charCode=source.charCodeAt(++Index)),charCode>=48&&57>=charCode){for(48==charCode&&(charCode=source.charCodeAt(Index+1),charCode>=48&&57>=charCode)&&abort(),isSigned=!1;length>Index&&(charCode=source.charCodeAt(Index),charCode>=48&&57>=charCode);Index++);if(46==source.charCodeAt(Index)){for(position=++Index;length>position&&(charCode=source.charCodeAt(position),charCode>=48&&57>=charCode);position++);position==Index&&abort(),Index=position}if(charCode=source.charCodeAt(Index),101==charCode||69==charCode){for(charCode=source.charCodeAt(++Index),(43==charCode||45==charCode)&&Index++,position=Index;length>position&&(charCode=source.charCodeAt(position),charCode>=48&&57>=charCode);position++);position==Index&&abort(),Index=position}return+source.slice(begin,Index)}if(isSigned&&abort(),"true"==source.slice(Index,Index+4))return Index+=4,!0;if("false"==source.slice(Index,Index+5))return Index+=5,!1;if("null"==source.slice(Index,Index+4))return Index+=4,null;abort()}return"$"},get=function(value){var results,hasMembers;if("$"==value&&abort(),"string"==typeof value){if("@"==(charIndexBuggy?value.charAt(0):value[0]))return value.slice(1);if("["==value){for(results=[];value=lex(),"]"!=value;hasMembers||(hasMembers=!0))hasMembers&&(","==value?(value=lex(),"]"==value&&abort()):abort()),","==value&&abort(),results.push(get(value));return results}if("{"==value){for(results={};value=lex(),"}"!=value;hasMembers||(hasMembers=!0))hasMembers&&(","==value?(value=lex(),"}"==value&&abort()):abort()),(","==value||"string"!=typeof value||"@"!=(charIndexBuggy?value.charAt(0):value[0])||":"!=lex())&&abort(),results[value.slice(1)]=get(lex());return results}abort()}return value},update=function(source,property,callback){var element=walk(source,property,callback);element===undef?delete source[property]:source[property]=element},walk=function(source,property,callback){var length,value=source[property];if("object"==typeof value&&value)if(getClass.call(value)==arrayClass)for(length=value.length;length--;)update(value,length,callback);else forEach(value,function(property){update(value,property,callback)});return callback.call(source,property,value)};JSON3.parse=function(source,callback){var result,value;return Index=0,Source=""+source,result=get(lex()),"$"!=lex()&&abort(),Index=Source=null,callback&&getClass.call(callback)==functionClass?walk((value={},value[""]=result,value),"",callback):result}}}isLoader&&define(function(){return JSON3})}(this)},{}],43:[function(require,module){function toArray(list,index){var array=[];index=index||0;for(var i=index||0;i<list.length;i++)array[i-index]=list[i];return array}module.exports=toArray},{}]},{},[1])(1)});var Temasys=Temasys||{};if(Temasys.WebRTCPlugin=Temasys.WebRTCPlugin||{},Temasys.WebRTCPlugin.temPluginInfo={pluginId:"plugin0",type:"application/x-temwebrtcplugin",onload:"__TemWebRTCReady0"},Temasys.WebRTCPlugin.TemPageId=Math.random().toString(36).slice(2),Temasys.WebRTCPlugin.TemRTCPlugin=null,Temasys.WebRTCPlugin.defineWebRTCInterface=null,Temasys.WebRTCPlugin.isPluginInstalled=null,Temasys.WebRTCPlugin.isDefined=null,Temasys.WebRTCPlugin.pluginInjectionInterval=null,Temasys.WebRTCPlugin.injectPlugin=null,Temasys.WebRTCPlugin.PLUGIN_STATES={NONE:0,INITIALIZING:1,INJECTING:2,INJECTED:3,READY:4},Temasys.WebRTCPlugin.pluginState=Temasys.WebRTCPlugin.PLUGIN_STATES.NONE,Temasys.WebRTCPlugin.WaitForPluginReady=null,Temasys.WebRTCPlugin.callWhenPluginReady=null,Temasys.WebRTCPlugin.pluginNeededButNotInstalledCb=null,__TemWebRTCReady0=function(){arguments.callee.StaticWasInit=arguments.callee.StaticWasInit||1,1===arguments.callee.StaticWasInit&&(Temasys.WebRTCPlugin.documentReadyInterval=setInterval(function(){"complete"===document.readyState&&(clearInterval(Temasys.WebRTCPlugin.documentReadyInterval),Temasys.WebRTCPlugin.pluginState=Temasys.WebRTCPlugin.PLUGIN_STATES.READY)},100)),arguments.callee.StaticWasInit++},Temasys.AdapterJS={},Temasys.AdapterJS.VERSION="0.9.2",Temasys.AdapterJS._iceConnectionStates={starting:"starting",checking:"checking",connected:"connected",completed:"connected",done:"completed",disconnected:"disconnected",failed:"failed",closed:"closed"},Temasys.AdapterJS._iceConnectionFiredStates=[],Temasys.AdapterJS.parseWebrtcDetectedBrowser=function(){var hasMatch,checkMatch=navigator.userAgent.match(/(opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];if(/trident/i.test(checkMatch[1])?(hasMatch=/\brv[ :]+(\d+)/g.exec(navigator.userAgent)||[],webrtcDetectedBrowser="IE",webrtcDetectedVersion=parseInt(hasMatch[1]||"0",10)):"Chrome"===checkMatch[1]&&(hasMatch=navigator.userAgent.match(/\bOPR\/(\d+)/),null!==hasMatch&&(webrtcDetectedBrowser="opera",webrtcDetectedVersion=parseInt(hasMatch[1],10))),navigator.userAgent.indexOf("Safari")&&("undefined"!=typeof InstallTrigger?webrtcDetectedBrowser="firefox":document.documentMode?webrtcDetectedBrowser="IE":Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")>0?webrtcDetectedBrowser="safari":window.opera||navigator.userAgent.indexOf(" OPR/")>=0?webrtcDetectedBrowser="opera":window.chrome&&(webrtcDetectedBrowser="chrome")),webrtcDetectedBrowser||(webrtcDetectedVersion=checkMatch[1]),!webrtcDetectedVersion)try{checkMatch=checkMatch[2]?[checkMatch[1],checkMatch[2]]:[navigator.appName,navigator.appVersion,"-?"],null!==(hasMatch=navigator.userAgent.match(/version\/(\d+)/i))&&checkMatch.splice(1,1,hasMatch[1]),webrtcDetectedVersion=parseInt(checkMatch[1],10)}catch(error){}},Temasys.AdapterJS.maybeFixConfiguration=function(pcConfig){if(null!==pcConfig)for(var i=0;i<pcConfig.iceServers.length;i++)pcConfig.iceServers[i].hasOwnProperty("urls")&&(pcConfig.iceServers[i].url=pcConfig.iceServers[i].urls,delete pcConfig.iceServers[i].urls)},webrtcDetectedType=null,webrtcDetectedDCSupport=null,checkMediaDataChannelSettings=function(peerBrowserAgent,peerBrowserVersion,callback,constraints){if("function"==typeof callback){var beOfferer=!0,isLocalFirefox="firefox"===webrtcDetectedBrowser,isLocalFirefoxInterop="moz"===webrtcDetectedType&&webrtcDetectedVersion>30,isPeerFirefox="firefox"===peerBrowserAgent;if(isLocalFirefox&&isPeerFirefox||isLocalFirefoxInterop)try{delete constraints.mandatory.MozDontOfferDataChannel}catch(error){}else isLocalFirefox&&!isPeerFirefox&&(constraints.mandatory.MozDontOfferDataChannel=!0);if(!isLocalFirefox)for(var prop in constraints.mandatory)constraints.mandatory.hasOwnProperty(prop)&&-1!==prop.indexOf("Moz")&&delete constraints.mandatory[prop];!isLocalFirefox||isPeerFirefox||isLocalFirefoxInterop||(beOfferer=!1),callback(beOfferer,constraints)}},checkIceConnectionState=function(peerId,iceConnectionState,callback){"function"==typeof callback&&(peerId=peerId?peerId:"peer",Temasys.AdapterJS._iceConnectionFiredStates[peerId]&&iceConnectionState!==Temasys.AdapterJS._iceConnectionStates.disconnected&&iceConnectionState!==Temasys.AdapterJS._iceConnectionStates.failed&&iceConnectionState!==Temasys.AdapterJS._iceConnectionStates.closed||(Temasys.AdapterJS._iceConnectionFiredStates[peerId]=[]),iceConnectionState=Temasys.AdapterJS._iceConnectionStates[iceConnectionState],Temasys.AdapterJS._iceConnectionFiredStates[peerId].indexOf(iceConnectionState)<0&&(Temasys.AdapterJS._iceConnectionFiredStates[peerId].push(iceConnectionState),iceConnectionState===Temasys.AdapterJS._iceConnectionStates.connected&&setTimeout(function(){Temasys.AdapterJS._iceConnectionFiredStates[peerId].push(Temasys.AdapterJS._iceConnectionStates.done),callback(Temasys.AdapterJS._iceConnectionStates.done)},1e3),callback(iceConnectionState)))},createIceServer=null,createIceServers=null,RTCPeerConnection=null,RTCSessionDescription="function"==typeof RTCSessionDescription?RTCSessionDescription:null,RTCIceCandidate="function"==typeof RTCIceCandidate?RTCIceCandidate:null,getUserMedia=null,attachMediaStream=null,reattachMediaStream=null,webrtcDetectedBrowser=null,webrtcDetectedVersion=null,navigator.mozGetUserMedia)webrtcDetectedBrowser="firefox",webrtcDetectedVersion=parseInt(navigator.userAgent.match(/Firefox\/([0-9]+)\./)[1],10),webrtcDetectedType="moz",webrtcDetectedDCSupport="SCTP",RTCPeerConnection=function(pcConfig,pcConstraints){return Temasys.AdapterJS.maybeFixConfiguration(pcConfig),new mozRTCPeerConnection(pcConfig,pcConstraints)},RTCSessionDescription=mozRTCSessionDescription,RTCIceCandidate=mozRTCIceCandidate,getUserMedia=navigator.mozGetUserMedia.bind(navigator),navigator.getUserMedia=getUserMedia,createIceServer=function(url,username,password){var iceServer=null,url_parts=url.split(":");if(0===url_parts[0].indexOf("stun"))iceServer={url:url};else if(0===url_parts[0].indexOf("turn"))if(27>webrtcDetectedVersion){var turn_url_parts=url.split("?");(1===turn_url_parts.length||0===turn_url_parts[1].indexOf("transport=udp"))&&(iceServer={url:turn_url_parts[0],credential:password,username:username})}else iceServer={url:url,credential:password,username:username};return iceServer},createIceServers=function(urls,username,password){var iceServers=[];for(i=0;i<urls.length;i++){var iceServer=createIceServer(urls[i],username,password);null!==iceServer&&iceServers.push(iceServer)}return iceServers},attachMediaStream=function(element,stream){return element.mozSrcObject=stream,element.play(),element},reattachMediaStream=function(to,from){return to.mozSrcObject=from.mozSrcObject,to.play(),to},MediaStreamTrack.getSources=MediaStreamTrack.getSources||function(callback){if(!callback)throw new TypeError("Failed to execute 'getSources' on 'MediaStreamTrack': 1 argument required, but only 0 present.");return callback([])},MediaStream.prototype.getVideoTracks||(MediaStream.prototype.getVideoTracks=function(){return[]}),MediaStream.prototype.getAudioTracks||(MediaStream.prototype.getAudioTracks=function(){return[]});else if(navigator.webkitGetUserMedia){webrtcDetectedBrowser="chrome",webrtcDetectedType="webkit",webrtcDetectedVersion=parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2],10);var checkIfOpera=navigator.userAgent.match(/\bOPR\/(\d+)/);null!==checkIfOpera&&(webrtcDetectedBrowser="opera",webrtcDetectedVersion=parseInt(checkIfOpera[1],10)),webrtcDetectedDCSupport="chrome"===webrtcDetectedBrowser&&webrtcDetectedVersion>=31||"opera"===webrtcDetectedBrowser&&webrtcDetectedVersion>=20?"SCTP":"chrome"===webrtcDetectedBrowser&&30>webrtcDetectedVersion&&webrtcDetectedVersion>24?"RTP":"",createIceServer=function(url,username,password){var iceServer=null,url_parts=url.split(":");return 0===url_parts[0].indexOf("stun")?iceServer={url:url}:0===url_parts[0].indexOf("turn")&&(iceServer={url:url,credential:password,username:username}),iceServer},createIceServers=function(urls,username,password){var iceServers=[];if(webrtcDetectedVersion>=34)iceServers={urls:urls,credential:password,username:username};else for(i=0;i<urls.length;i++){var iceServer=createIceServer(urls[i],username,password);null!==iceServer&&iceServers.push(iceServer)}return iceServers},RTCPeerConnection=function(pcConfig,pcConstraints){return 34>webrtcDetectedVersion&&Temasys.AdapterJS.maybeFixConfiguration(pcConfig),new webkitRTCPeerConnection(pcConfig,pcConstraints)},getUserMedia=navigator.webkitGetUserMedia.bind(navigator),navigator.getUserMedia=getUserMedia,attachMediaStream=function(element,stream){return"undefined"!=typeof element.srcObject?element.srcObject=stream:"undefined"!=typeof element.mozSrcObject?element.mozSrcObject=stream:"undefined"!=typeof element.src&&(element.src=URL.createObjectURL(stream)),element},reattachMediaStream=function(to,from){return to.src=from.src,to}}else("object"!=typeof console||"function"!=typeof console.log)&&(console={}||console,console.log=function(){},console.info=function(){},console.error=function(){},console.dir=function(){},console.exception=function(){},console.trace=function(){},console.warn=function(){},console.count=function(){},console.debug=function(){},console.count=function(){},console.time=function(){},console.timeEnd=function(){},console.group=function(){},console.groupCollapsed=function(){},console.groupEnd=function(){}),webrtcDetectedType="plugin",webrtcDetectedDCSupport="plugin",Temasys.AdapterJS.parseWebrtcDetectedBrowser(),isIE="IE"===webrtcDetectedBrowser,Temasys.WebRTCPlugin.WaitForPluginReady=function(){for(;Temasys.WebRTCPlugin.pluginState!==Temasys.WebRTCPlugin.PLUGIN_STATES.READY;);},Temasys.WebRTCPlugin.callWhenPluginReady=function(callback){var checkPluginReadyState=setInterval(function(){Temasys.WebRTCPlugin.pluginState===Temasys.WebRTCPlugin.PLUGIN_STATES.READY&&(clearInterval(checkPluginReadyState),callback())},100)},Temasys.WebRTCPlugin.injectPlugin=function(){if("complete"===document.readyState&&Temasys.WebRTCPlugin.pluginState===Temasys.WebRTCPlugin.PLUGIN_STATES.INITIALIZING){if(Temasys.WebRTCPlugin.pluginState=Temasys.WebRTCPlugin.PLUGIN_STATES.INJECTING,"IE"===webrtcDetectedBrowser&&9>=webrtcDetectedVersion){var frag=document.createDocumentFragment();for(Temasys.WebRTCPlugin.TemRTCPlugin=document.createElement("div"),Temasys.WebRTCPlugin.TemRTCPlugin.innerHTML='<object id="'+Temasys.WebRTCPlugin.temPluginInfo.pluginId+'" type="'+Temasys.WebRTCPlugin.temPluginInfo.type+'" width="1" height="1"><param name="pluginId" value="'+Temasys.WebRTCPlugin.temPluginInfo.pluginId+'" /> <param name="windowless" value="false" /> <param name="pageId" value="'+Temasys.WebRTCPlugin.TemPageId+'" /> <param name="onload" value="'+Temasys.WebRTCPlugin.temPluginInfo.onload+'" /></object>';Temasys.WebRTCPlugin.TemRTCPlugin.firstChild;)frag.appendChild(Temasys.WebRTCPlugin.TemRTCPlugin.firstChild);document.body.appendChild(frag),Temasys.WebRTCPlugin.TemRTCPlugin=document.getElementById(Temasys.WebRTCPlugin.temPluginInfo.pluginId)}else Temasys.WebRTCPlugin.TemRTCPlugin=document.createElement("object"),Temasys.WebRTCPlugin.TemRTCPlugin.id=Temasys.WebRTCPlugin.temPluginInfo.pluginId,isIE&&(Temasys.WebRTCPlugin.TemRTCPlugin.width="1px",Temasys.WebRTCPlugin.TemRTCPlugin.height="1px"),Temasys.WebRTCPlugin.TemRTCPlugin.width="1px",Temasys.WebRTCPlugin.TemRTCPlugin.height="1px",Temasys.WebRTCPlugin.TemRTCPlugin.type=Temasys.WebRTCPlugin.temPluginInfo.type,Temasys.WebRTCPlugin.TemRTCPlugin.innerHTML='<param name="onload" value="'+Temasys.WebRTCPlugin.temPluginInfo.onload+'"><param name="pluginId" value="'+Temasys.WebRTCPlugin.temPluginInfo.pluginId+'"><param name="windowless" value="false" /> <param name="pageId" value="'+Temasys.WebRTCPlugin.TemPageId+'">',document.body.appendChild(Temasys.WebRTCPlugin.TemRTCPlugin);Temasys.WebRTCPlugin.pluginState=Temasys.WebRTCPlugin.PLUGIN_STATES.INJECTED}},Temasys.WebRTCPlugin.isPluginInstalled=function(comName,plugName,installedCb,notInstalledCb){if(isIE){try{{new ActiveXObject(comName+"."+plugName)}}catch(e){return void notInstalledCb()}installedCb()}else{for(var pluginArray=navigator.plugins,i=0;i<pluginArray.length;i++)if(pluginArray[i].name.indexOf(plugName)>=0)return void installedCb();notInstalledCb()}},Temasys.WebRTCPlugin.defineWebRTCInterface=function(){Temasys.WebRTCPlugin.pluginState=Temasys.WebRTCPlugin.PLUGIN_STATES.INITIALIZING,Temasys.WebRTCPlugin.isDefined=function(variable){return null!==variable&&void 0!==variable},createIceServer=function(url,username,password){var iceServer=null,url_parts=url.split(":");return 0===url_parts[0].indexOf("stun")?iceServer={url:url,hasCredentials:!1}:0===url_parts[0].indexOf("turn")&&(iceServer={url:url,hasCredentials:!0,credential:password,username:username}),iceServer},createIceServers=function(urls,username,password){for(var iceServers=[],i=0;i<urls.length;++i)iceServers.push(createIceServer(urls[i],username,password));return iceServers},RTCSessionDescription=function(info){return Temasys.WebRTCPlugin.WaitForPluginReady(),Temasys.WebRTCPlugin.TemRTCPlugin.ConstructSessionDescription(info.type,info.sdp)},RTCPeerConnection=function(servers,constraints){var iceServers=null;if(servers){iceServers=servers.iceServers;for(var i=0;i<iceServers.length;i++)iceServers[i].urls&&!iceServers[i].url&&(iceServers[i].url=iceServers[i].urls),iceServers[i].hasCredentials=Temasys.WebRTCPlugin.isDefined(iceServers[i].username)&&Temasys.WebRTCPlugin.isDefined(iceServers[i].credential)}var mandatory=constraints&&constraints.mandatory?constraints.mandatory:null,optional=constraints&&constraints.optional?constraints.optional:null;return Temasys.WebRTCPlugin.WaitForPluginReady(),Temasys.WebRTCPlugin.TemRTCPlugin.PeerConnection(Temasys.WebRTCPlugin.TemPageId,iceServers,mandatory,optional)},MediaStreamTrack={},MediaStreamTrack.getSources=function(callback){Temasys.WebRTCPlugin.callWhenPluginReady(function(){Temasys.WebRTCPlugin.TemRTCPlugin.GetSources(callback)})},getUserMedia=function(constraints,successCallback,failureCallback){constraints.audio||(constraints.audio=!1),Temasys.WebRTCPlugin.callWhenPluginReady(function(){Temasys.WebRTCPlugin.TemRTCPlugin.getUserMedia(constraints,successCallback,failureCallback)})},navigator.getUserMedia=getUserMedia,attachMediaStream=function(element,stream){if(stream.enableSoundTracks(!0),"audio"!==element.nodeName.toLowerCase()){var elementId=0===element.id.length?Math.random().toString(36).slice(2):element.id;if(element.isTemWebRTCPlugin&&element.isTemWebRTCPlugin()){for(var children=element.children,i=0;i!==children.length;++i)if("streamId"===children[i].name){children[i].value=stream.id;break}element.setStreamId(stream.id)}else{var frag=document.createDocumentFragment(),temp=document.createElement("div"),classHTML=element.className?'class="'+element.className+'" ':"";for(temp.innerHTML='<object id="'+elementId+'" '+classHTML+'type="application/x-temwebrtcplugin"><param name="pluginId" value="'+elementId+'" /> <param name="pageId" value="'+Temasys.WebRTCPlugin.TemPageId+'" /> <param name="windowless" value="true" /> <param name="streamId" value="'+stream.id+'" /> </object>';temp.firstChild;)frag.appendChild(temp.firstChild);var rectObject=element.getBoundingClientRect();element.parentNode.insertBefore(frag,element),frag=document.getElementById(elementId),frag.width=rectObject.width+"px",frag.height=rectObject.height+"px",element.parentNode.removeChild(element)}var newElement=document.getElementById(elementId);return newElement.onplaying=element.onplaying?element.onplaying:function(){},isIE&&(newElement.attachEvent("onplaying",newElement.onplaying),newElement.onclick=element.onclick?element.onclick:function(){},newElement._TemOnClick=function(id){var arg={srcElement:document.getElementById(id)};newElement.onclick(arg)}),newElement}return element},reattachMediaStream=function(to,from){for(var stream=null,children=from.children,i=0;i!==children.length;++i)if("streamId"===children[i].name){Temasys.WebRTCPlugin.WaitForPluginReady(),stream=Temasys.WebRTCPlugin.TemRTCPlugin.getStreamWithId(Temasys.WebRTCPlugin.TemPageId,children[i].value);break}return null!==stream?attachMediaStream(to,stream):void 0},RTCIceCandidate=function(candidate){return candidate.sdpMid||(candidate.sdpMid=""),Temasys.WebRTCPlugin.WaitForPluginReady(),Temasys.WebRTCPlugin.TemRTCPlugin.ConstructIceCandidate(candidate.sdpMid,candidate.sdpMLineIndex,candidate.candidate)},document.onreadystatechange=Temasys.WebRTCPlugin.injectPlugin,Temasys.WebRTCPlugin.injectPlugin()},Temasys.WebRTCPlugin.getWebsiteLink=function(){return"http://temasys.atlassian.net/wiki/display/TWPP/WebRTC+Plugins"},Temasys.WebRTCPlugin.getDownloadLink=function(){return navigator.platform.match(/^Mac/i)?"http://bit.ly/1n77hco":navigator.platform.match(/^Win/i)?"http://bit.ly/1kkS4FN":null},Temasys.WebRTCPlugin.pluginNeededButNotInstalledCb=function(){var downloadLink=Temasys.WebRTCPlugin.getDownloadLink();downloadLink?Temasys.WebRTCPlugin.renderNotificationBar('This website needs to install the <a href="'+Temasys.WebRTCPlugin.getWebsiteLink()+'" target="_blank">Temasys WebRTC Plugin</a> to upgrade your browser.',"Install Now",downloadLink):Temasys.WebRTCPlugin.renderNotificationBar("Your browser does not support WebRTC.")},Temasys.WebRTCPlugin.renderNotificationBar=function(text,buttonText,buttonLink){var w=window,i=document.createElement("iframe");i.style.position="fixed",i.style.top="-41px",i.style.left=0,i.style.right=0,i.style.width="100%",i.style.height="40px",i.style.backgroundColor="#ffffe1",i.style.border="none",i.style.borderBottom="1px solid #888888",i.style.zIndex="9999999","string"==typeof i.style.webkitTransition?i.style.webkitTransition="all .5s ease-out":"string"==typeof i.style.transition&&(i.style.transition="all .5s ease-out"),document.body.appendChild(i),c=i.contentWindow?i.contentWindow:i.contentDocument.document?i.contentDocument.document:i.contentDocument,c.document.open(),c.document.write('<span style="font-family: Helvetica, Arial,sans-serif; font-size: .9rem; padding: 7px; vertical-align: middle; cursor: default;">'+text+"</span>"),buttonText&&buttonLink?(c.document.write('<button id="okay">'+buttonText+"</button><button>Cancel</button>"),c.document.close(),c.document.getElementById("okay").addEventListener("click",function(e){window.open(buttonLink,"_top"),e.preventDefault();
try{event.cancelBubble=!0}catch(error){}})):c.document.close(),c.document.addEventListener("click",function(){w.document.body.removeChild(i)}),setTimeout(function(){"string"==typeof i.style.webkitTransform?i.style.webkitTransform="translateY(40px)":"string"==typeof i.style.transform?i.style.transform="translateY(40px)":i.style.top="0px"},300)},Temasys.WebRTCPlugin.isPluginInstalled("Tem","TemWebRTCPlugin",Temasys.WebRTCPlugin.defineWebRTCInterface,Temasys.WebRTCPlugin.pluginNeededButNotInstalledCb);(function(){function Skyway(){return this instanceof Skyway?(this.VERSION="0.5.2",this.LOG_LEVEL={DEBUG:"debug",TRACE:"log",INFO:"info",WARN:"warn",ERROR:"error"},this._CHUNK_FILE_SIZE=49152,this._MOZ_CHUNK_FILE_SIZE=16384,this._SIG_MESSAGE_TYPE={JOIN_ROOM:"joinRoom",IN_ROOM:"inRoom",ENTER:"enter",WELCOME:"welcome",OFFER:"offer",ANSWER:"answer",CANDIDATE:"candidate",BYE:"bye",REDIRECT:"redirect",UPDATE_USER:"updateUserEvent",ROOM_LOCK:"roomLockEvent",MUTE_VIDEO:"muteVideoEvent",MUTE_AUDIO:"muteAudioEvent",PUBLIC_MESSAGE:"public",PRIVATE_MESSAGE:"private",GROUP:"group"},this._DC_PROTOCOL_TYPE={WRQ:"WRQ",ACK:"ACK",ERROR:"ERROR",CANCEL:"CANCEL",MESSAGE:"MESSAGE"},this.REGIONAL_SERVER={APAC1:"sg",US1:"us2"},this.ICE_CONNECTION_STATE={STARTING:"starting",CHECKING:"checking",CONNECTED:"connected",COMPLETED:"completed",CLOSED:"closed",FAILED:"failed",DISCONNECTED:"disconnected"},this.PEER_CONNECTION_STATE={STABLE:"stable",HAVE_LOCAL_OFFER:"have-local-offer",HAVE_REMOTE_OFFER:"have-remote-offer",HAVE_LOCAL_PRANSWER:"have-local-pranswer",HAVE_REMOTE_PRANSWER:"have-remote-pranswer",CLOSED:"closed"},this.CANDIDATE_GENERATION_STATE={NEW:"new",GATHERING:"gathering",COMPLETED:"completed"},this.HANDSHAKE_PROGRESS={ENTER:"enter",WELCOME:"welcome",OFFER:"offer",ANSWER:"answer",ERROR:"error"},this.DATA_CHANNEL_STATE={CONNECTING:"connecting",OPEN:"open",CLOSING:"closing",CLOSED:"closed",ERROR:"error"},this.READY_STATE_CHANGE={INIT:0,LOADING:1,COMPLETED:2,ERROR:-1},this.READY_STATE_CHANGE_ERROR={API_INVALID:4001,API_DOMAIN_NOT_MATCH:4002,API_CORS_DOMAIN_NOT_MATCH:4003,API_CREDENTIALS_INVALID:4004,API_CREDENTIALS_NOT_MATCH:4005,API_INVALID_PARENT_KEY:4006,API_NOT_ENOUGH_CREDIT:4007,API_NOT_ENOUGH_PREPAID_CREDIT:4008,API_FAILED_FINDING_PREPAID_CREDIT:4009,API_NO_MEETING_RECORD_FOUND:4010,ROOM_LOCKED:5001,NO_SOCKET_IO:1,NO_XMLHTTPREQUEST_SUPPORT:2,NO_WEBRTC_SUPPORT:3,NO_PATH:4,INVALID_XMLHTTPREQUEST_STATUS:5,SCRIPT_ERROR:6},this.VIDEO_RESOLUTION={QVGA:{width:320,height:180},VGA:{width:640,height:360},HD:{width:1280,height:720},FHD:{width:1920,height:1080}},this.DATA_TRANSFER_TYPE={UPLOAD:"upload",DOWNLOAD:"download"},this.DATA_TRANSFER_STATE={UPLOAD_REQUEST:"request",UPLOAD_STARTED:"uploadStarted",DOWNLOAD_STARTED:"downloadStarted",REJECTED:"rejected",CANCEL:"cancel",ERROR:"error",UPLOADING:"uploading",DOWNLOADING:"downloading",UPLOAD_COMPLETED:"uploadCompleted",DOWNLOAD_COMPLETED:"downloadCompleted"},this.DATA_TRANSFER_DATA_TYPE={BINARY_STRING:"binaryString",ARRAY_BUFFER:"arrayBuffer",BLOB:"blob"},this.SYSTEM_ACTION={WARNING:"warning",REJECT:"reject"},this.SYSTEM_ACTION_REASON={FAST_MESSAGE:"fastmsg",ROOM_LOCKED:"locked",ROOM_FULL:"roomfull",DUPLICATED_LOGIN:"duplicatedLogin",SERVER_ERROR:"serverError",VERIFICATION:"verification",EXPIRED:"expired",ROOM_CLOSED:"roomclose",ROOM_CLOSING:"toclose",OVER_SEAT_LIMIT:"seatquota"},this._logLevel="warn",this._path=null,this._serverRegion=null,this._roomServer="//api.temasys.com.sg",this._apiKey=null,this._defaultRoom=null,this._selectedRoom=null,this._roomStart=null,this._roomDuration=null,this._roomCredentials=null,this._enableIceTrickle=!0,this._enableDataChannel=!0,this._streamSettings={audio:!1,video:!1},this._readyState=0,this._channelOpen=!1,this._roomLocked=!1,this._key=null,this._socket=null,this._user=null,this._room=null,this._peerConnections=[],this._peerInformations=[],this._peerCandidatesQueue=[],this._peerHSPriorities=[],this._dataChannels=[],this._uploadDataTransfers=[],this._uploadDataSessions=[],this._downloadDataTransfers=[],this._downloadDataSessions=[],this._dataTransfersTimeout=[],void(this._EVENTS={channelOpen:[],channelClose:[],channelMessage:[],channelError:[],readyStateChange:[],handshakeProgress:[],candidateGenerationState:[],peerConnectionState:[],iceConnectionState:[],mediaAccessError:[],mediaAccessSuccess:[],peerJoined:[],peerUpdated:[],peerLeft:[],presenceChanged:[],incomingStream:[],incomingMessage:[],roomLock:[],dataChannelState:[],dataTransferState:[],systemAction:[]})):new Skyway}this.Skyway=Skyway,Skyway.prototype._log=function(logLevel,message,debugObject){var logOrders={debug:4,log:3,info:2,warn:1,error:0};return"number"!=typeof logOrders[logLevel]?void this._log(this.LOG_LEVEL.ERROR,"- Invalid log level provided. Provided log level: ",logLevel):void(logOrders[this._logLevel]>=logOrders[logLevel]&&(message="SkywayJS "+message))},Skyway.prototype._requestServerInfo=function(method,url,callback,params){var self=this,xhr=new window.XMLHttpRequest;self._log(self.LOG_LEVEL.DEBUG,"- ("+method+") Retrieving information and config from webserver. Url: ",url),self._log(self.LOG_LEVEL.DEBUG,"- ("+method+") Provided parameters: ",params),xhr.onreadystatechange=function(){xhr.readyState===xhr.DONE&&(200!==xhr.status&&self._log(self.LOG_LEVEL.ERROR,"- Failed retrieving information: ",{status:xhr.status}),self._log(self.LOG_LEVEL.DEBUG,"- Received sessions parameters",JSON.parse(xhr.response||"{}")),callback(xhr.status,JSON.parse(xhr.response||"{}")))},xhr.open(method,url,!0),params?(xhr.setRequestHeader("Content-type","application/json;charset=UTF-8"),xhr.send(JSON.stringify(params))):xhr.send()},Skyway.prototype._parseInfo=function(info){return this._log(this.LOG_LEVEL.TRACE,"- Parsing parameter from server",info),info.pc_constraints||info.offer_constraints?(this._log(this.LOG_LEVEL.DEBUG,"- Peer connection constraints: ",info.pc_constraints),this._log(this.LOG_LEVEL.DEBUG,"- Offer constraints: ",info.offer_constraints),this._key=info.cid,this._user={id:info.username,token:info.userCred,timeStamp:info.timeStamp,apiOwner:info.apiOwner,streams:[],info:{}},this._room={id:info.room_key,token:info.roomCred,start:info.start,len:info.len,signalingServer:info.ipSigserver,pcHelper:{pcConstraints:JSON.parse(info.pc_constraints),pcConfig:null,offerConstraints:JSON.parse(info.offer_constraints),sdpConstraints:{mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}}}},this._readyState=2,this._trigger("readyStateChange",this.READY_STATE_CHANGE.COMPLETED),void this._log(this.LOG_LEVEL.INFO,"- Parsed parameters from webserver. Ready for web-realtime communication")):void this._trigger("readyStateChange",this.READY_STATE_CHANGE.ERROR,{status:200,content:info.info,errorCode:info.error})},Skyway.prototype._loadInfo=function(){var self=this;return window.io?window.XMLHttpRequest?window.RTCPeerConnection?self._path?(self._readyState=1,self._trigger("readyStateChange",self.READY_STATE_CHANGE.LOADING),void self._requestServerInfo("GET",self._path,function(status,response){if(200!==status){var errorMessage="XMLHttpRequest status not OK\nStatus was: "+status;return self._readyState=0,void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:status,content:response?response.info||errorMessage:errorMessage,errorCode:response.error||self.READY_STATE_CHANGE_ERROR.INVALID_XMLHTTPREQUEST_STATUS})}self._parseInfo(response)})):(self._log(self.LOG_LEVEL.ERROR,"- Skyway is not initialised. Please call init() first"),void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:null,content:"No API Path is found",errorCode:self.READY_STATE_CHANGE_ERROR.NO_PATH})):(self._log(self.LOG_LEVEL.ERROR,"- WebRTC not supported. Please upgrade your browser"),void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:null,content:"WebRTC not available",errorCode:self.READY_STATE_CHANGE_ERROR.NO_WEBRTC_SUPPORT})):(self._log(self.LOG_LEVEL.ERROR,"- XMLHttpRequest not supported. Please upgrade your browser"),void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:null,content:"XMLHttpRequest not available",errorCode:self.READY_STATE_CHANGE_ERROR.NO_XMLHTTPREQUEST_SUPPORT})):(self._log(self.LOG_LEVEL.ERROR,"- Socket.io not loaded. Please load socket.io"),void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:null,content:"Socket.io not found",errorCode:self.READY_STATE_CHANGE_ERROR.NO_SOCKET_IO}))},Skyway.prototype._reInitAndLoadInfo=function(options,callback){var startDateTime,duration,credentials,self=this,apiKey=options.apiKey||self._apiKey,roomServer=options.roomServer||self._roomServer;roomServer=roomServer.lastIndexOf("/")===roomServer.length-1?roomServer.substring(0,roomServer.length-1):roomServer;var region=options.region||self._serverRegion,defaultRoom=options.defaultRoom||self._defaultRoom,room=options.room||defaultRoom,iceTrickle="boolean"==typeof options.iceTrickle?options.iceTrickle:self._enableIceTrickle,dataChannel="boolean"==typeof options.dataChannel?options.dataChannel:self._enableDataChannel;options.credentials?(startDateTime=options.credentials.startDateTime||(new Date).toISOString(),duration=options.credentials.duration||500,credentials=options.credentials.credentials||self._roomCredentials):self._roomCredentials&&(startDateTime=self._roomStart,duration=self._roomDuration,credentials=self._roomCredentials),self._log(self.LOG_LEVEL.TRACE,"- ("+room+") Joining selected room"),self._apiKey=apiKey,self._roomServer=roomServer,self._defaultRoom=defaultRoom,self._selectedRoom=room,self._serverRegion=region,self._enableIceTrickle=iceTrickle,self._enableDataChannel=dataChannel,self._path=roomServer+"/api/"+apiKey+"/"+room,credentials&&(self._roomStart=startDateTime,self._roomDuration=duration,self._roomCredentials=credentials,self._path+=credentials?"/"+startDateTime+"/"+duration+"?&cred="+credentials:""),region&&(self._path+=(self._path.indexOf("?&")>-1?"&":"?&")+"rg="+region),self._log(self.LOG_LEVEL.TRACE,"- Init configuration: ",{serverUrl:this._path,readyState:this._readyState,apiKey:this._apiKey,roomServer:this._roomServer,defaultRoom:this._defaultRoom,selectedRoom:this._selectedRoom,serverRegion:this._serverRegion,enableDataChannel:this._enableDataChannel,enableIceTrickle:this._enableIceTrickle}),self._requestServerInfo("GET",self._path,function(status,response){if(200!==status){var errorMessage="XMLHttpRequest status not OK.\nStatus was: "+status;return self._readyState=0,void self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:status,content:response?response.info||errorMessage:errorMessage,errorCode:response.error||self.READY_STATE_CHANGE_ERROR.INVALID_XMLHTTPREQUEST_STATUS})}var info=response;try{self._key=info.cid,self._user={id:info.username,token:info.userCred,timeStamp:info.timeStamp,apiOwner:info.apiOwner,streams:[]},self._room={id:info.room_key,token:info.roomCred,start:info.start,len:info.len,signalingServer:info.ipSigserver,pcHelper:{pcConstraints:JSON.parse(info.pc_constraints),pcConfig:null,offerConstraints:JSON.parse(info.offer_constraints),sdpConstraints:{mandatory:{OfferToReceiveAudio:!0,OfferToReceiveVideo:!0}}}},callback()}catch(error){return self._readyState=0,self._trigger("readyStateChange",self.READY_STATE_CHANGE.ERROR,{status:null,content:error,errorCode:self.READY_STATE_CHANGE_ERROR.SCRIPT_ERROR}),void self._log(self.LOG_LEVEL.ERROR,"- ("+room+") Failed joining room: ",error)}})},Skyway.prototype._trigger=function(eventName){var args=Array.prototype.slice.call(arguments),arr=this._EVENTS[eventName];if(args.shift(),arr)for(var e in arr)if(arr.hasOwnProperty(e))try{if(arr[e].apply(this,args)===!1)break}catch(error){this._log(self.LOG_LEVEL.ERROR,"- ("+eventName+") Exception occurred in event: ",error)}this._log(this.LOG_LEVEL.TRACE,"- ("+eventName+") Event is triggered")},Skyway.prototype._onUserMediaSuccess=function(stream){var self=this;self._log(self.LOG_LEVEL.TRACE,"- <<MediaStream>> ("+stream.id+") User has granted access to local media",stream),self._trigger("mediaAccessSuccess",stream);var checkReadyState=setInterval(function(){if(self._readyState===self.READY_STATE_CHANGE.COMPLETED){clearInterval(checkReadyState),self._user.streams[stream.id]=stream,self._user.streams[stream.id].active=!0;var checkIfUserInRoom=setInterval(function(){self._inRoom&&(clearInterval(checkIfUserInRoom),self._trigger("incomingStream",self._user.sid,stream,!0))},500)}},500)},Skyway.prototype._onUserMediaError=function(error){this._log(this.LOG_LEVEL.ERROR,"- <<MediaStream>> Failed retrieving stream: ",error),this._trigger("mediaAccessError",error)},Skyway.prototype._onRemoteStreamAdded=function(targetMid,event){"MCU"!==targetMid?"default"===event.stream.id?this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - <<MediaStream>> ("+event.stream.id+") Received empty default stream. Ignoring stream",event.stream):(this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - <<MediaStream>> ("+event.stream.id+") Received remote stream -> ",event.stream),this._trigger("incomingStream",targetMid,event.stream,!1)):this._log(this.LOG_LEVEL.TRACE,"[MCU] - MCU is listening.")},Skyway.prototype._onIceCandidate=function(targetMid,event){if(event.candidate){if(this._enableIceTrickle){var messageCan=event.candidate.candidate.split(" "),candidateType=messageCan[7];this._log(this.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceCandidate>> Created and sending "+candidateType+" candidate: ",event),this._sendChannelMessage({type:this._SIG_MESSAGE_TYPE.CANDIDATE,label:event.candidate.sdpMLineIndex,id:event.candidate.sdpMid,candidate:event.candidate.candidate,mid:this._user.sid,target:targetMid,rid:this._room.id})}}else if(this._log(this.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceCandidate>> End of gathering"),this._trigger("candidateGenerationState",this.CANDIDATE_GENERATION_STATE.COMPLETED,targetMid),!this._enableIceTrickle){var sessionDescription=this._peerConnections[targetMid].localDescription;this._sendChannelMessage({type:sessionDescription.type,sdp:sessionDescription.sdp,mid:this._user.sid,agent:window.webrtcDetectedBrowser,target:targetMid,rid:this._room.id})}},Skyway.prototype._processSigMessage=function(messageString){var message=JSON.parse(messageString);if(message.type===this._SIG_MESSAGE_TYPE.GROUP){this._log(this.LOG_LEVEL.DEBUG,"- Bundle of "+message.lists.length+" messages");for(var i=0;i<message.lists.length;i++)this._processSingleMessage(message.lists[i])}else this._processSingleMessage(message)},Skyway.prototype._processSingleMessage=function(message){this._trigger("channelMessage",message);var origin=message.mid;if(origin&&origin!==this._user.sid||(origin="Server"),this._log(this.LOG_LEVEL.DEBUG,"["+origin+"] - Recevied from peer -> "+message.type),message.mid===this._user.sid&&message.type!==this._SIG_MESSAGE_TYPE.REDIRECT&&message.type!==this._SIG_MESSAGE_TYPE.IN_ROOM)return void this._log(this.LOG_LEVEL.DEBUG,"["+origin+"] - Ignoring message -> "+message.type);switch(message.type){case this._SIG_MESSAGE_TYPE.PUBLIC_MESSAGE:this._publicMessageHandler(message);break;case this._SIG_MESSAGE_TYPE.PRIVATE_MESSAGE:this._privateMessageHandler(message);break;case this._SIG_MESSAGE_TYPE.IN_ROOM:this._inRoomHandler(message);break;case this._SIG_MESSAGE_TYPE.ENTER:this._enterHandler(message);break;case this._SIG_MESSAGE_TYPE.WELCOME:this._welcomeHandler(message);break;case this._SIG_MESSAGE_TYPE.OFFER:this._offerHandler(message);break;case this._SIG_MESSAGE_TYPE.ANSWER:this._answerHandler(message);break;case this._SIG_MESSAGE_TYPE.CANDIDATE:this._candidateHandler(message);break;case this._SIG_MESSAGE_TYPE.BYE:this._byeHandler(message);break;case this._SIG_MESSAGE_TYPE.REDIRECT:this._redirectHandler(message);break;case this._SIG_MESSAGE_TYPE.UPDATE_USER:this._updateUserEventHandler(message);break;case this._SIG_MESSAGE_TYPE.MUTE_VIDEO:this._muteVideoEventHandler(message);break;case this._SIG_MESSAGE_TYPE.MUTE_AUDIO:this._muteAudioEventHandler(message);break;case this._SIG_MESSAGE_TYPE.ROOM_LOCK:this._roomLockEventHandler(message);break;default:this._log(this.LOG_LEVEL.ERROR,"["+message.mid+"] - Unsupported message -> "+message.type)}},Skyway.prototype._redirectHandler=function(message){this._log(this.LOG_LEVEL.TRACE,"[Server] - ("+message.type+") System action warning: ",{message:message.info,reason:message.reason,action:message.action}),this._trigger("systemAction",message.action,message.info,message.reason)},Skyway.prototype._updateUserEventHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer updated userData: ",message.userData),this._peerInformations[targetMid]?(this._peerInformations[targetMid].userData=message.userData||{},this._trigger("peerUpdated",targetMid,this._peerInformations[targetMid],!1)):this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer does not have any user information")},Skyway.prototype._roomLockEventHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Room lock status: ",message.lock),this._trigger("roomLock",message.lock,targetMid,this._peerInformations[targetMid],!1)},Skyway.prototype._muteAudioEventHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer's audio muted: ",message.muted),this._peerInformations[targetMid]?(this._peerInformations[targetMid].mediaStatus.audioMuted=message.muted,this._trigger("peerUpdated",targetMid,this._peerInformations[targetMid],!1)):this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer does not have any user information")},Skyway.prototype._muteVideoEventHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer's video muted: ",message.muted),this._peerInformations[targetMid]?(this._peerInformations[targetMid].mediaStatus.videoMuted=message.muted,this._trigger("peerUpdated",targetMid,this._peerInformations[targetMid],!1)):this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer does not have any user information")},Skyway.prototype._byeHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer has left the room"),this._removePeer(targetMid)},Skyway.prototype._privateMessageHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received private message from peer: ",message.data),this._trigger("incomingMessage",{content:message.data,isPrivate:!0,targetPeerId:message.target,isDataChannel:!1,senderPeerId:targetMid},targetMid,this._peerInformations[targetMid],!1)},Skyway.prototype._publicMessageHandler=function(message){var targetMid=message.mid;this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received public message from peer: ",message.data),this._trigger("incomingMessage",{content:message.data,isPrivate:!1,targetPeerId:null,isDataChannel:!1,senderPeerId:targetMid},targetMid,this._peerInformations[targetMid],!1)},Skyway.prototype._inRoomHandler=function(message){var self=this;self._log(self.LOG_LEVEL.TRACE,"[Server] - ("+message.type+") User is now in the room and functionalities are now available. Config received: ",message.pc_config),self._room.pcHelper.pcConfig=self._setFirefoxIceServers(message.pc_config),self._inRoom=!0,self._user.sid=message.sid,self._trigger("peerJoined",self._user.sid,self._user.info,!0),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ENTER,self._user.sid),self._sendChannelMessage({type:self._SIG_MESSAGE_TYPE.ENTER,mid:self._user.sid,rid:self._room.id,agent:window.webrtcDetectedBrowser,version:window.webrtcDetectedVersion,userInfo:self._user.info})},Skyway.prototype._enterHandler=function(message){var self=this,targetMid=message.mid;if(self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Incoming peer have initiated handshake. Peer's information: ",message.userInfo),self._peerInformations[targetMid])return void self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Ignoring message as peer is already added");self._addPeer(targetMid,{agent:message.agent,version:message.version},!1),self._peerInformations[targetMid]=message.userInfo,"MCU"!==targetMid?(self._trigger("peerJoined",targetMid,message.userInfo,!1),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ENTER,targetMid),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.WELCOME,targetMid)):self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") MCU has joined",message.userInfo);var weight=(new Date).valueOf();self._peerHSPriorities[targetMid]=weight,self._sendChannelMessage({type:self._SIG_MESSAGE_TYPE.WELCOME,mid:self._user.sid,rid:self._room.id,agent:window.webrtcDetectedBrowser,version:window.webrtcDetectedVersion,userInfo:self._user.info,target:targetMid,weight:weight})},Skyway.prototype._welcomeHandler=function(message){var targetMid=message.mid;if(this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received peer's response to handshake initiation. Peer's information: ",message.userInfo),this._peerConnections[targetMid]){if(this._peerConnections[targetMid].setOffer)return void this._log(this.LOG_LEVEL.WARN,"["+targetMid+"] - ("+message.type+") Ignoring message as peer is already added");if(message.weight<0)this._removePeer(targetMid),this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Peer's weight is lower than 0. Proceeding with offer",message.weight);else{if(!(this._peerHSPriorities[targetMid]>message.weight))return void this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") User's generated weight is lesser than peer's. Ignoring message",this._peerHSPriorities[targetMid]+" < "+message.weight);this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") User's generated weight is higher than peer's. Proceeding with offer",this._peerHSPriorities[targetMid]+" > "+message.weight)}}message.agent=message.agent?message.agent:"chrome",this._enableIceTrickle="boolean"==typeof message.enableIceTrickle?message.enableIceTrickle:this._enableIceTrickle,this._enableDataChannel="boolean"==typeof message.enableDataChannel?message.enableDataChannel:this._enableDataChannel,this._peerInformations[targetMid]||(this._peerInformations[targetMid]=message.userInfo,"MCU"!==targetMid?(this._trigger("peerJoined",targetMid,message.userInfo,!1),this._trigger("handshakeProgress",this.HANDSHAKE_PROGRESS.WELCOME,targetMid)):this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") MCU has "+(message.weight>-1?"joined and ":"")+" responded")),this._addPeer(targetMid,{agent:message.agent,version:message.version},!0,message.receiveOnly)},Skyway.prototype._offerHandler=function(message){var self=this,targetMid=message.mid,pc=self._peerConnections[targetMid];if(!pc)return void self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - ("+message.type+" ) Peer connection object not found. Unable to setRemoteDescription for offer");self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received offer from peer. Session description: ",message.sdp),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.OFFER,targetMid);var offer=new window.RTCSessionDescription(message);self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - <<RTCSessionDescription>> ("+message.type+") Session description object created",offer),pc.setRemoteDescription(new window.RTCSessionDescription(offer),function(){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - ("+message.type+") Remote description set"),pc.setOffer="remote",self._addIceCandidateFromQueue(targetMid),self._doAnswer(targetMid)},function(error){self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ERROR,targetMid,error),self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - ("+message.type+") Failed setting remote description: ",error)})},Skyway.prototype._candidateHandler=function(message){var targetMid=message.mid,pc=this._peerConnections[targetMid];this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received candidate from peer. Candidate config: ",{sdp:message.sdp,target:message.target,candidate:message.candidate,label:message.label});var messageCan=message.candidate.split(" "),canType=messageCan[7];this._log(this.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Candidate type: ",canType);var index=message.label,candidate=new window.RTCIceCandidate({sdpMLineIndex:index,candidate:message.candidate});pc?"local"===pc.setOffer&&"remote"===pc.setAnswer||"local"===pc.setAnswer&&"remote"===pc.setOffer?(pc.addIceCandidate(candidate),this._log(this.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceCandidate>> ("+message.type+") Added candidate",candidate)):this._addIceCandidateToQueue(targetMid,candidate):(this._log(this.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceCandidate>> ("+message.type+") Not adding candidate as peer connection not present"),this._addIceCandidateToQueue(targetMid,candidate))},Skyway.prototype._answerHandler=function(message){var self=this,targetMid=message.mid;self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+message.type+") Received answer from peer. Session description: ",message.sdp),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ANSWER,targetMid);var answer=new window.RTCSessionDescription(message);self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - <<RTCSessionDescription>> ("+message.type+") Session description object created",answer);var pc=self._peerConnections[targetMid];"moz"===window.webrtcDetectedType&&"MCU"===targetMid&&(message.sdp=message.sdp.replace(/ generation 0/g,""),message.sdp=message.sdp.replace(/ udp /g," UDP ")),pc.setRemoteDescription(new window.RTCSessionDescription(answer),function(){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - ("+message.type+") Remote description set"),pc.setAnswer="remote",self._addIceCandidateFromQueue(targetMid)},function(error){self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ERROR,targetMid,error),self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - ("+message.type+") Failed setting remote description: ",error)})},Skyway.prototype._addPeer=function(targetMid,peerBrowser,toOffer,receiveOnly){var self=this;return self._peerConnections[targetMid]?void self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - Connection to peer has already been made"):(self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - Starting the connection to peer. Options provided: ",{peerBrowser:peerBrowser,toOffer:toOffer,receiveOnly:receiveOnly,enableDataChannel:self._enableDataChannel}),self._peerConnections[targetMid]=self._createPeerConnection(targetMid),receiveOnly||self._addLocalMediaStreams(targetMid),void(toOffer&&(self._enableDataChannel&&self._createDataChannel(targetMid),self._doOffer(targetMid,peerBrowser))))},Skyway.prototype._removePeer=function(peerId){"MCU"!==peerId?this._trigger("peerLeft",peerId,this._peerInformations[peerId],!1):this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - MCU has stopped listening and left"),this._peerConnections[peerId]&&(this._peerConnections[peerId].close(),delete this._peerConnections[peerId]),delete this._peerHSPriorities[peerId],delete this._peerInformations[peerId],this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - Successfully removed peer")},Skyway.prototype._doOffer=function(targetMid,peerBrowser){var self=this,pc=self._peerConnections[targetMid];self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - Checking caller status",peerBrowser);var inputConstraints=self._room.pcHelper.offerConstraints,sc=self._room.pcHelper.sdpConstraints;for(var name in sc.mandatory)sc.mandatory.hasOwnProperty(name)&&(inputConstraints.mandatory[name]=sc.mandatory[name]);inputConstraints.optional.concat(sc.optional),checkMediaDataChannelSettings(peerBrowser.agent,peerBrowser.version,function(beOfferer,unifiedOfferConstraints){"moz"===window.webrtcDetectedType&&"MCU"===peerBrowser.agent&&(unifiedOfferConstraints.mandatory=unifiedOfferConstraints.mandatory||{},unifiedOfferConstraints.mandatory.MozDontOfferDataChannel=!0,beOfferer=!0),beOfferer?(self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - Creating offer with config: ",unifiedOfferConstraints),pc.createOffer(function(offer){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - Created offer",offer),self._setLocalAndSendMessage(targetMid,offer)},function(error){self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ERROR,targetMid,error),self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - Failed creating an offer: ",error)},unifiedOfferConstraints)):(self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - User's browser is not eligible to create the offer to the other peer. Requesting other peer to create the offer instead",peerBrowser),self._sendChannelMessage({type:self._SIG_MESSAGE_TYPE.WELCOME,mid:self._user.sid,rid:self._room.id,agent:window.webrtcDetectedBrowser,version:window.webrtcDetectedVersion,userInfo:self._user.info,target:targetMid,weight:-1}))},inputConstraints)},Skyway.prototype._doAnswer=function(targetMid){var self=this;self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - Creating answer with config: ",self._room.pcHelper.sdpConstraints);var pc=self._peerConnections[targetMid];return pc?void pc.createAnswer(function(answer){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - Created answer",answer),self._setLocalAndSendMessage(targetMid,answer)},function(error){self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - Failed creating an answer: ",error),self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ERROR,targetMid,error)},self._room.pcHelper.sdpConstraints):void self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - Requested to create an answer but user does not have any existing connection to peer")},Skyway.prototype._addIceCandidateToQueue=function(targetMid,candidate){this._log(this.LOG_LEVEL.DEBUG,"["+targetMid+"] - Queued candidate to add after setRemoteDescription",candidate),this._peerCandidatesQueue[targetMid]=this._peerCandidatesQueue[targetMid]||[],this._peerCandidatesQueue[targetMid].push(candidate)},Skyway.prototype._addIceCandidateFromQueue=function(targetMid){if(this._peerCandidatesQueue[targetMid]=this._peerCandidatesQueue[targetMid]||[],this._peerCandidatesQueue[targetMid].length>0){for(var i=0;i<this._peerCandidatesQueue[targetMid].length;i++){var candidate=this._peerCandidatesQueue[targetMid][i];this._log(this.LOG_LEVEL.DEBUG,"- ["+targetMid+"] - Added queued candidate",candidate),this._peerConnections[targetMid].addIceCandidate(candidate)}delete this._peerCandidatesQueue[targetMid]}else this._log(this.LOG_LEVEL.TRACE,"- ["+targetMid+"] - No queued candiate to add")},Skyway.prototype._setLocalAndSendMessage=function(targetMid,sessionDescription){var self=this,pc=self._peerConnections[targetMid];if(sessionDescription.type===self.HANDSHAKE_PROGRESS.ANSWER&&pc.setAnswer)return void self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+sessionDescription.type+") Ignoring session description. User has already set local answer");if(sessionDescription.type===self.HANDSHAKE_PROGRESS.OFFER&&pc.setOffer)return void self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+sessionDescription.type+") Ignoring session description. User has already set local offer");var sdpLines=sessionDescription.sdp.split("\r\n");self._streamSettings.stereo&&self._addStereo(sdpLines),self._log(self.LOG_LEVEL.INFO,"["+targetMid+"] - Requested stereo: ",self._streamSettings.stereo||!1),self._streamSettings.bandwidth&&(sdpLines=self._setSDPBitrate(sdpLines,self._streamSettings.bandwidth)),self._streamSettings.bandwidth=self._streamSettings.bandwidth||{},self._log(self.LOG_LEVEL.INFO,"["+targetMid+"] - Custom bandwidth settings: ",{audio:(self._streamSettings.bandwidth.audio||"Not set")+" kB/s",video:(self._streamSettings.bandwidth.video||"Not set")+" kB/s",data:(self._streamSettings.bandwidth.data||"Not set")+" kB/s"}),sessionDescription.sdp=sdpLines.join("\r\n"),self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - <<RTCSessionDescription>> ("+sessionDescription.type+") Updated session description: ",sessionDescription),pc.setLocalDescription(sessionDescription,function(){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - ("+sessionDescription.type+") Local description set"),self._trigger("handshakeProgress",sessionDescription.type,targetMid),sessionDescription.type===self.HANDSHAKE_PROGRESS.ANSWER?pc.setAnswer="local":pc.setOffer="local",self._enableIceTrickle||!self._enableIceTrickle&&sessionDescription.type!==self.HANDSHAKE_PROGRESS.OFFER?self._sendChannelMessage({type:sessionDescription.type,sdp:sessionDescription.sdp,mid:self._user.sid,target:targetMid,rid:self._room.id}):self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - ("+sessionDescription.type+") Waiting for Ice gathering to complete to prevent Ice trickle")
},function(error){self._trigger("handshakeProgress",self.HANDSHAKE_PROGRESS.ERROR,targetMid,error),self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - ("+sessionDescription.type+") Failed setting local description: ",error)})},Skyway.prototype._setFirefoxIceServers=function(config){if("moz"===window.webrtcDetectedType){this._log(this.LOG_LEVEL.TRACE,"- Updating firefox Ice server configuration",config);for(var newIceServers=[{url:"stun:stun.services.mozilla.com"}],i=0;i<config.iceServers.length;i++){var iceServer=config.iceServers[i],iceServerType=iceServer.url.split(":")[0];if("stun"===iceServerType){if(iceServer.url.indexOf("google"))continue;iceServer.url=[iceServer.url],newIceServers.push(iceServer)}else{var newIceServer={};newIceServer.credential=iceServer.credential,newIceServer.url=iceServer.url.split(":")[0],newIceServer.username=iceServer.url.split(":")[1].split("@")[0],newIceServer.url+=":"+iceServer.url.split(":")[1].split("@")[1],newIceServers.push(newIceServer)}}config.iceServers=newIceServers,this._log(this.LOG_LEVEL.DEBUG,"- Updated firefox Ice server configuration: ",config)}return config},Skyway.prototype._findSDPLine=function(sdpLines,condition,value){for(var index in sdpLines)if(sdpLines.hasOwnProperty(index))for(var c in condition)if(condition.hasOwnProperty(c)&&0===sdpLines[index].indexOf(c))return sdpLines[index]=value,[index,sdpLines[index]];return[]},Skyway.prototype._addStereo=function(sdpLines){var opusLineFound=!1,opusPayload=0,rtpmapLine=this._findSDPLine(sdpLines,["a=rtpmap:"]);if(rtpmapLine.length&&0===rtpmapLine[1].split(" ")[1].indexOf("opus/48000/")&&(opusLineFound=!0,opusPayload=rtpmapLine[1].split(" ")[0].split(":")[1]),opusLineFound){var fmtpLine=this._findSDPLine(sdpLines,["a=fmtp:"+opusPayload]);fmtpLine.length&&(sdpLines[fmtpLine[0]]=fmtpLine[1]+"; stereo=1")}return sdpLines},Skyway.prototype._setSDPBitrate=function(sdpLines){var bandwidth=this._streamSettings.bandwidth,maLineFound=this._findSDPLine(sdpLines,["m=","a="]).length,cLineFound=this._findSDPLine(sdpLines,["c="]).length;if(maLineFound&&cLineFound){if(bandwidth.audio){var audioLine=this._findSDPLine(sdpLines,["a=mid:audio","m=mid:audio"]);sdpLines.splice(audioLine[0],0,"b=AS:"+bandwidth.audio)}if(bandwidth.video){var videoLine=this._findSDPLine(sdpLines,["a=mid:video","m=mid:video"]);sdpLines.splice(videoLine[0],0,"b=AS:"+bandwidth.video)}if(bandwidth.data){var dataLine=this._findSDPLine(sdpLines,["a=mid:data","m=mid:data"]);sdpLines.splice(dataLine[0],0,"b=AS:"+bandwidth.data)}}return sdpLines},Skyway.prototype._parseStreamSettings=function(options){if(options=options||{},this._log(this.LOG_LEVEL.DEBUG,"- Parsing stream settings. Stream options: ",options),this._user.info=this._user.info||{},this._user.info.settings=this._user.info.settings||{},this._user.info.mediaStatus=this._user.info.mediaStatus||{},this._user.info.userData=options.userData||this._user.info.userData||"",this._streamSettings.bandwidth=options.bandwidth||this._streamSettings.bandwidth||{},this._user.info.settings.bandwidth=options.bandwidth||this._user.info.settings.bandwidth||{},this._user.info.settings.audio="boolean"==typeof options.audio||"object"==typeof options.audio?options.audio:this._streamSettings.audio||!1,this._user.info.mediaStatus.audioMuted=options.audio?"boolean"==typeof this._user.info.mediaStatus.audioMuted?this._user.info.mediaStatus.audioMuted:!options.audio:!0,this._user.info.settings.video="boolean"==typeof options.video||"object"==typeof options.video?options.video:this._streamSettings.video||!1,this._user.info.mediaStatus.videoMuted=options.video?"boolean"==typeof this._user.info.mediaStatus.videoMuted?this._user.info.mediaStatus.videoMuted:!options.video:!0,options.video||options.audio){if(options.video=options.video||!1,options.audio=options.audio||!1,"object"==typeof options.video&&"object"==typeof options.video.resolution){var width=options.video.resolution.width,height=options.video.resolution.height,frameRate="number"==typeof options.video.frameRate?options.video.frameRate:50;options.video=width&&height?{mandatory:{minWidth:width,minHeight:height},optional:[{minFrameRate:frameRate}]}:!0}"object"==typeof options.audio&&(options.stereo="boolean"==typeof options.audio.stereo?options.audio.stereo:!1,options.audio=!0),this._streamSettings.video=options.video,this._streamSettings.audio=options.audio,this._streamSettings.stereo=options.stereo,this._log(this.LOG_LEVEL.DEBUG,"- Parsed user stream settings",this._user.info),this._log(this.LOG_LEVEL.INFO,"- User media status: ",{audio:options.audioMuted,video:options.videoMuted})}},Skyway.prototype._setLocalMediaStreams=function(options){var hasAudioTracks=!1,hasVideoTracks=!1;if(!this._user)return void this._log(this.LOG_LEVEL.ERROR,"- User have no active streams");for(var stream in this._user.streams)if(this._user.streams.hasOwnProperty(stream)){var audios=this._user.streams[stream].getAudioTracks(),videos=this._user.streams[stream].getVideoTracks();for(var audio in audios)audios.hasOwnProperty(audio)&&(audios[audio].enabled=options.audio,hasAudioTracks=!0);for(var video in videos)videos.hasOwnProperty(video)&&(videos[video].enabled=options.video,hasVideoTracks=!0);this._user.streams[stream].active=options.video||options.audio?!0:!1}return!hasAudioTracks&&options.audio||!hasVideoTracks&&options.video},Skyway.prototype._addLocalMediaStreams=function(peerId){if(this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - Adding local stream"),Object.keys(this._user.streams).length>0)for(var stream in this._user.streams)this._user.streams.hasOwnProperty(stream)&&this._user.streams[stream].active&&(this._peerConnections[peerId].addStream(this._user.streams[stream]),this._log(this.LOG_LEVEL.DEBUG,"["+peerId+"] - <<MediaStream>> ("+stream+") Sending stream"));else this._log(this.LOG_LEVEL.WARN,"["+peerId+"] - No media to send. Will be only receiving")},Skyway.prototype._handleLocalMediaStreams=function(mediaType,enableMedia){if("audio"===mediaType||"video"===mediaType){if(!this._inRoom)return void this._log(this.LOG_LEVEL.ERROR,"- Failed "+(enableMedia?"enabling":"disabling")+" "+mediaType+". User is not in the room");var hasTracks=!1,isStreamActive=!1;for(var stream in this._user.streams)if(this._user.streams.hasOwnProperty(stream)){var tracks="audio"===mediaType?this._user.streams[stream].getAudioTracks():this._user.streams[stream].getVideoTracks();for(var track in tracks)tracks.hasOwnProperty(track)&&(tracks[track].enabled=enableMedia,hasTracks=!0);isStreamActive=this._user.streams[stream].active}if(this._log(this.LOG_LEVEL.TRACE,"- Update to is"+mediaType+"Muted status -> ",enableMedia),hasTracks&&isStreamActive||!enableMedia)this._sendChannelMessage({type:"audio"===mediaType?this._SIG_MESSAGE_TYPE.MUTE_AUDIO:this._SIG_MESSAGE_TYPE.MUTE_VIDEO,mid:this._user.sid,rid:this._room.id,muted:!enableMedia});else{this.leaveRoom();var hasProperty=this._user&&this._user.info&&this._user.info.settings?!0:!1;this.joinRoom({audio:"audio"===mediaType?!0:hasProperty?this._user.info.settings.audio:!1,video:"video"===mediaType?!0:hasProperty?this._user.info.settings.video:!1})}this._user.info.mediaStatus[mediaType+"Muted"]=!enableMedia,this._trigger("peerUpdated",this._user.sid,this._user.info,!0)}},Skyway.prototype._waitForLocalMediaStream=function(callback,options){var self=this;options=options||{},self.getUserMedia(options),self._log(self.LOG_LEVEL.TRACE,"- Requested audio: ","boolean"==typeof options.audio?options.audio:!1),self._log(self.LOG_LEVEL.TRACE,"- Requested video: ","boolean"==typeof options.video?options.video:!1);var hasAudio=options.audio?!1:!0,hasVideo=options.video?!1:!0;if(options.video||options.audio)var count=0,checkForStream=setInterval(function(){if(5>count)for(var stream in self._user.streams)self._user.streams.hasOwnProperty(stream)&&(options.audio&&self._user.streams[stream].getAudioTracks().length>0&&(hasAudio=!0),options.video&&self._user.streams[stream].getVideoTracks().length>0&&(hasVideo=!0),hasAudio&&hasVideo?(clearInterval(checkForStream),callback()):count++);else{clearInterval(checkForStream);var error=(!hasAudio&&options.audio?"Expected audio but no audio stream received":"")+"\n"+(!hasVideo&&options.video?"Expected video but no video stream received":"");self._log(self.LOG_LEVEL.ERROR,"- ("+self._selectedRoom+") Failed joining room: ",error),self._trigger("mediaAccessError",error)}},2e3);else callback()},Skyway.prototype._createPeerConnection=function(targetMid){var pc,self=this;try{pc=new window.RTCPeerConnection(self._room.pcHelper.pcConfig,self._room.pcHelper.pcConstraints),self._log(self.LOG_LEVEL.INFO,"["+targetMid+"] - Created peer connection"),self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - Peer connection config: ",self._room.pcHelper.pcConfig),self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - Peer connection constraints: ",self._room.pcHelper.pcConstraints)}catch(error){return self._log(self.LOG_LEVEL.ERROR,"["+targetMid+"] - Failed creating peer connection: ",error),null}return pc.setOffer="",pc.setAnswer="",pc.ondatachannel=function(event){var dc=event.channel||event;self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCDataChannel>> ("+dc.label+") Received datachannel -> ",dc),self._enableDataChannel?self._createDataChannel(targetMid,dc):self._log(self.LOG_LEVEL.WARN,"["+targetMid+"] - <<RTCDataChannel>> ("+dc.label+") Not adding datachannel")},pc.onaddstream=function(event){self._onRemoteStreamAdded(targetMid,event)},pc.onicecandidate=function(event){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceCandidate>> Ice candidate generated -> ",event.candidate),self._onIceCandidate(targetMid,event)},pc.oniceconnectionstatechange=function(){checkIceConnectionState(targetMid,pc.iceConnectionState,function(iceConnectionState){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCIceConnectionState>> Ice connection state changed -> "+iceConnectionState),self._trigger("iceConnectionState",iceConnectionState,targetMid)})},pc.onsignalingstatechange=function(){self._log(self.LOG_LEVEL.DEBUG,"["+targetMid+"] - <<RTCSignalingState>> Peer connection state changed -> "+pc.signalingState),self._trigger("peerConnectionState",pc.signalingState,targetMid)},pc.onicegatheringstatechange=function(){self._log(self.LOG_LEVEL.TRACE,"["+targetMid+"] - <<RTCIceGatheringState>> Ice gathering state changed -> "+pc.iceGatheringState),self._trigger("candidateGenerationState",pc.iceGatheringState,targetMid)},pc},Skyway.prototype._createDataChannel=function(peerId,dc){var self=this,channelName=dc?dc.label:peerId,pc=self._peerConnections[peerId],dcOpened=function(){self._log(self.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Datachannel state -> open"),self._log(self.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Binary type support -> "+dc.binaryType),self._dataChannels[peerId]=dc,self._trigger("dataChannelState",dc.readyState,peerId)};if("SCTP"!==window.webrtcDetectedDCSupport&&"plugin"!==window.webrtcDetectedDCSupport)return void self._log(self.LOG_LEVEL.WARN,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") SCTP not supported");if(!dc){dc=pc.createDataChannel(channelName),self._trigger("dataChannelState",dc.readyState,peerId);var checkDcOpened=setInterval(function(){dc.readyState===self.DATA_CHANNEL_STATE.OPEN&&(clearInterval(checkDcOpened),dcOpened())},50)}dc.readyState===self.DATA_CHANNEL_STATE.OPEN?dcOpened():dc.onopen=dcOpened,dc.onerror=function(error){self._log(self.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Exception occurred in datachannel: ",error),self._trigger("dataChannelState",self.DATA_CHANNEL_STATE.ERROR,peerId,error)},dc.onclose=function(){self._log(self.LOG_LEVEL.DEBUG,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Datachannel state -> closed"),self._closeDataChannel(peerId),self._trigger("dataChannelState",self.DATA_CHANNEL_STATE.CLOSED,peerId),self._peerConnections[peerId]&&self._createDataChannel(peerId)},dc.onmessage=function(event){self._dataChannelProtocolHandler(event.data,peerId,channelName)}},Skyway.prototype._sendChannelMessage=function(message){if(this._channelOpen){var messageString=JSON.stringify(message);this._log(this.LOG_LEVEL.DEBUG,"["+(message.target?message.target:"server")+"] - Sending to peer"+(message.target?"":"s")+" -> "+message.type),this._socket.send(messageString)}},Skyway.prototype._openChannel=function(){var self=this;if(!self._channelOpen&&self._readyState===self.READY_STATE_CHANGE.COMPLETED){var ip_signaling=window.location.protocol+"//"+self._room.signalingServer+":"+("https:"===window.location.protocol?"443":"80");self._log(self.LOG_LEVEL.TRACE,"- Opening channel with signaling server url: ",ip_signaling),self._socket=io.connect(ip_signaling,{forceNew:!0}),self._socket.on("connect",function(){self._channelOpen=!0,self._trigger("channelOpen"),self._log(self.LOG_LEVEL.TRACE,"- (Socket) Channel opened")}),self._socket.on("error",function(error){self._channelOpen=!1,self._trigger("channelError",error),self._log(self.LOG_LEVEL.ERROR,"- (Socket) Exception occurred: ",error)}),self._socket.on("disconnect",function(){self._trigger("channelClose"),self._log(self.LOG_LEVEL.TRACE,"- (Socket) Channel closed")}),self._socket.on("message",function(message){self._log(self.LOG_LEVEL.TRACE,"- (Socket) Received message"),self._processSigMessage(message)})}},Skyway.prototype._closeChannel=function(){this._channelOpen&&(this._socket.disconnect(),this._socket=null,this._channelOpen=!1)},Skyway.prototype._sendDataChannelMessage=function(peerId,data){var dc=this._dataChannels[peerId];if(!dc)return void this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+dc.label+") Datachannel connection to peer does not exist");if(dc.readyState===this.DATA_CHANNEL_STATE.OPEN){var dataString="object"==typeof data?JSON.stringify(data):data;this._log(this.LOG_LEVEL.DEBUG,"["+peerId+"] - <<RTCDataChannel>> ("+dc.label+") Sending to peer -> "+(data.type||"DATA")),dc.send(dataString)}else this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+dc.label+") Datachannel is not opened","State: "+dc.readyState),this._trigger("dataChannelState",this.DATA_CHANNEL_STATE.ERROR,peerId,"Datachannel is not ready.\nState is: "+dc.readyState)},Skyway.prototype._closeDataChannel=function(peerId){var dc=this._dataChannels[peerId];dc&&(dc.readyState!==this.DATA_CHANNEL_STATE.CLOSED&&dc.close(),delete this._dataChannels[peerId],this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+dc.label+") Sucessfully removed datachannel."))},Skyway.prototype._setDataChannelTimeout=function(peerId,timeout,isSender){var self=this;self._dataTransfersTimeout[peerId]||(self._dataTransfersTimeout[peerId]=[]);var type=isSender?self.DATA_TRANSFER_TYPE.UPLOAD:self.DATA_TRANSFER_TYPE.DOWNLOAD;self._dataTransfersTimeout[peerId][type]=setTimeout(function(){var name;self._dataTransfersTimeout[peerId][type]&&(isSender?(name=self._uploadDataSessions[peerId].name,delete self._uploadDataTransfers[peerId],delete self._uploadDataSessions[peerId]):(name=self._downloadDataSessions[peerId].name,delete self._downloadDataTransfers[peerId],delete self._downloadDataSessions[peerId]),self._sendDataChannelMessage(peerId,{type:self._DC_PROTOCOL_TYPE.ERROR,sender:self._user.sid,name:name,content:"Connection Timeout. Longer than "+timeout+" seconds. Connection is abolished.",isUploadError:isSender}),self._log(self.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> () Failed transfering data: ","Transfer "+(isSender?"for":"from")+" "+peerId+" failed. Connection timeout"),self._clearDataChannelTimeout(peerId,isSender))},1e3*timeout)},Skyway.prototype._clearDataChannelTimeout=function(peerId,isSender){if(this._dataTransfersTimeout[peerId]){var type=isSender?this.DATA_TRANSFER_TYPE.UPLOAD:this.DATA_TRANSFER_TYPE.DOWNLOAD;clearTimeout(this._dataTransfersTimeout[peerId][type]),delete this._dataTransfersTimeout[peerId][type]}},Skyway.prototype._sendBlobDataToPeer=function(data,dataInfo,targetPeerId){var binarySize=parseInt((dataInfo.size*(4/3)).toFixed(),10),chunkSize=parseInt((this._CHUNK_FILE_SIZE*(4/3)).toFixed(),10);"firefox"===window.webrtcDetectedBrowser&&window.webrtcDetectedVersion<30&&(chunkSize=this._MOZ_CHUNK_FILE_SIZE),this._log(this.LOG_LEVEL.TRACE,"["+targetPeerId+"] - Chunk size of data: ",chunkSize),this._uploadDataTransfers[targetPeerId]=this._chunkBlobData(data,dataInfo.size),this._uploadDataSessions[targetPeerId]={name:dataInfo.name,size:binarySize,transferId:dataInfo.transferId,timeout:dataInfo.timeout},this._sendDataChannelMessage(targetPeerId,{type:this._DC_PROTOCOL_TYPE.WRQ,sender:this._user.sid,agent:window.webrtcDetectedBrowser,name:dataInfo.name,size:binarySize,chunkSize:chunkSize,timeout:dataInfo.timeout}),this._setDataChannelTimeout(targetPeerId,dataInfo.timeout,!0)},Skyway.prototype._dataChannelProtocolHandler=function(dataString,peerId,channelName){if("string"==typeof dataString){var data={};try{data=JSON.parse(dataString)}catch(error){return this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Received from peer -> DATA"),void this._DATAProtocolHandler(peerId,dataString,this.DATA_TRANSFER_DATA_TYPE.BINARY_STRING,channelName)}switch(this._log(this.LOG_LEVEL.DEBUG,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Received from peer -> "+data.type),data.type){case this._DC_PROTOCOL_TYPE.WRQ:this._WRQProtocolHandler(peerId,data,channelName);break;case this._DC_PROTOCOL_TYPE.ACK:this._ACKProtocolHandler(peerId,data,channelName);break;case this._DC_PROTOCOL_TYPE.ERROR:this._ERRORProtocolHandler(peerId,data,channelName);break;case this._DC_PROTOCOL_TYPE.CANCEL:this._CANCELProtocolHandler(peerId,data,channelName);break;case this._DC_PROTOCOL_TYPE.MESSAGE:this._MESSAGEProtocolHandler(peerId,data,channelName);break;default:this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+") Unsupported message -> "+data.type)}}},Skyway.prototype._WRQProtocolHandler=function(peerId,data,channelName){var transferId=this._user.sid+this.DATA_TRANSFER_TYPE.DOWNLOAD+(new Date).toISOString().replace(/-/g,"").replace(/:/g,"").replace(".","");this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(WRQ) Received file request from peer: ",data);var name=data.name,binarySize=data.size,expectedSize=data.chunkSize,timeout=data.timeout;this._downloadDataSessions[peerId]={transferId:transferId,name:name,size:binarySize,ackN:0,receivedSize:0,chunkSize:expectedSize,timeout:timeout},this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.UPLOAD_REQUEST,transferId,peerId,{name:name,size:binarySize,senderPeerId:peerId})},Skyway.prototype._ACKProtocolHandler=function(peerId,data,channelName){var self=this,ackN=data.ackN,chunksLength=self._uploadDataTransfers[peerId].length,uploadedDetails=self._uploadDataSessions[peerId],transferId=uploadedDetails.transferId,timeout=uploadedDetails.timeout;if(self._clearDataChannelTimeout(peerId,!0),self._log(self.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(ACK) ACK stage -> "+ackN+" / "+chunksLength),ackN>-1)if(chunksLength>ackN){var fileReader=new FileReader;fileReader.onload=function(){var base64BinaryString=fileReader.result.split(",")[1];self._sendDataChannelMessage(peerId,base64BinaryString),self._setDataChannelTimeout(peerId,timeout,!0),self._trigger("dataTransferState",self.DATA_TRANSFER_STATE.UPLOADING,transferId,peerId,{percentage:((ackN+1)/chunksLength*100).toFixed()})},fileReader.readAsDataURL(self._uploadDataTransfers[peerId][ackN])}else ackN===chunksLength&&(self._trigger("dataTransferState",self.DATA_TRANSFER_STATE.UPLOAD_COMPLETED,transferId,peerId,{name:uploadedDetails.name}),delete self._uploadDataTransfers[peerId],delete self._uploadDataSessions[peerId]);else self._trigger("dataTransferState",self.DATA_TRANSFER_STATE.REJECTED,transferId,peerId),delete self._uploadDataTransfers[peerId],delete self._uploadDataSessions[peerId]},Skyway.prototype._MESSAGEProtocolHandler=function(peerId,data,channelName){var targetMid=data.sender;this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(MESSAGE) Received P2P message from peer: ",data),this._trigger("incomingMessage",{content:data.data,isPrivate:data.isPrivate,isDataChannel:!0,targetPeerId:this._user.sid,senderPeerId:targetMid},targetMid,this._peerInformations[targetMid],!1)},Skyway.prototype._ERRORProtocolHandler=function(peerId,data,channelName){var isUploader=data.isUploadError,transferId=isUploader?this._uploadDataSessions[peerId].transferId:this._downloadDataSessions[peerId].transferId;this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(ERROR) Received an error from peer: ",data),this._clearDataChannelTimeout(peerId,isUploader),this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.ERROR,transferId,peerId,null,{name:data.name,message:data.content,transferType:isUploader?this.DATA_TRANSFER_TYPE.UPLOAD:this.DATA_TRANSFER_TYPE.DOWNLOAD})},Skyway.prototype._CANCELProtocolHandler=function(peerId,data,channelName){var isUploader=data.isUploadError,transferId=isUploader?this._uploadDataSessions[peerId].transferId:this._downloadDataSessions[peerId].transferId;this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(CANCEL) Received file transfer cancel request: ",data),this._clearDataChannelTimeout(peerId,isUploader),this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.CANCEL,transferId,peerId,null,{name:data.name,content:data.content,senderPeerId:data.sender,transferType:isUploader?this.DATA_TRANSFER_TYPE.UPLOAD:this.DATA_TRANSFER_TYPE.DOWNLOAD})},Skyway.prototype._DATAProtocolHandler=function(peerId,dataString,dataType,channelName){var chunk,error="",transferStatus=this._downloadDataSessions[peerId],transferId=transferStatus.transferId;if(this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Received data chunk from peer. Data type: ",dataType),this._clearDataChannelTimeout(peerId,!1),dataType===this.DATA_TRANSFER_DATA_TYPE.BINARY_STRING)chunk=this._base64ToBlob(dataString);else if(dataType===this.DATA_TRANSFER_DATA_TYPE.ARRAY_BUFFER)chunk=new Blob(dataString);else{if(dataType!==this.DATA_TRANSFER_DATA_TYPE.BLOB)return error="Unhandled data exception: "+dataType,this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Failed downloading data packets: ",error),void this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.ERROR,transferId,peerId,null,{message:error,transferType:this.DATA_TRANSFER_TYPE.DOWNLOAD});chunk=dataString}var receivedSize=chunk.size*(4/3);if(this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Received data chunk size: "+receivedSize),this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Expected data chunk size: "+transferStatus.chunkSize),transferStatus.chunkSize>=receivedSize){this._downloadDataTransfers[peerId].push(chunk),transferStatus.ackN+=1,transferStatus.receivedSize+=receivedSize;var totalReceivedSize=transferStatus.receivedSize,percentage=(totalReceivedSize/transferStatus.size*100).toFixed();if(this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.ACK,sender:this._user.sid,ackN:transferStatus.ackN}),transferStatus.chunkSize===receivedSize)this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Transfer in progress"),this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.DOWNLOADING,transferId,peerId,{percentage:percentage}),this._setDataChannelTimeout(peerId,transferStatus.timeout,!1),this._downloadDataTransfers[peerId].info=transferStatus;else{this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Download complete");var blob=new Blob(this._downloadDataTransfers[peerId]);this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.DOWNLOAD_COMPLETED,transferId,peerId,{data:blob}),delete this._downloadDataTransfers[peerId],delete this._downloadDataSessions[peerId]}}else error="Packet not match - [Received]"+receivedSize+" / [Expected]"+transferStatus.chunkSize,this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.ERROR,transferId,peerId,null,{message:error,transferType:this.DATA_TRANSFER_TYPE.DOWNLOAD}),this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] - <<RTCDataChannel>> ("+channelName+")(DATA) Failed downloading data packets: ",error)},Skyway.prototype._base64ToBlob=function(dataURL){for(var byteString=atob(dataURL.replace(/\s\r\n/g,"")),ab=new ArrayBuffer(byteString.length),ia=new Uint8Array(ab),j=0;j<byteString.length;j++)ia[j]=byteString.charCodeAt(j);return new Blob([ab])},Skyway.prototype._chunkBlobData=function(blob,blobByteSize){var chunksArray=[],startCount=0,endCount=0;if(blobByteSize>this._CHUNK_FILE_SIZE){for(;blobByteSize-1>endCount;)endCount=startCount+this._CHUNK_FILE_SIZE,chunksArray.push(blob.slice(startCount,endCount)),startCount+=this._CHUNK_FILE_SIZE;blobByteSize-(startCount+1)>0&&chunksArray.push(blob.slice(startCount,blobByteSize-1))}else chunksArray.push(blob);return chunksArray},Skyway.prototype.setLogLevel=function(logLevel){for(var level in this.LOG_LEVEL)if(this.LOG_LEVEL[level]===logLevel)return this._logLevel=logLevel,void this._log(this.LOG_LEVEL.TRACE,"- ("+level+") Log level exists. Level is set");this._log(this.LOG_LEVEL.ERROR,"- ("+level+") Log level does not exist. Level is not set")},Skyway.prototype.on=function(eventName,callback){"function"==typeof callback&&(this._EVENTS[eventName]=this._EVENTS[eventName]||[],this._EVENTS[eventName].push(callback),this._log(this.LOG_LEVEL.TRACE,"- ("+eventName+") Event is subscribed"))},Skyway.prototype.off=function(eventName,callback){if(void 0===callback)return this._EVENTS[eventName]=[],void this._log(self.LOG_LEVEL.ERROR,"- ("+eventName+") Unable to unsubscribe event with invalid callback");for(var arr=this._EVENTS[eventName],l=arr.length,i=0;l>i;i++)if(arr[i]===callback){arr.splice(i,1);break}this._log(this.LOG_LEVEL.TRACE,"- ("+eventName+") Event is unsubscribed")},Skyway.prototype.init=function(options){if(!options)return void this._log(this.LOG_LEVEL.ERROR,"- No API key provided");var apiKey,room,defaultRoom,region,startDateTime,duration,credentials,roomServer=this._roomServer,iceTrickle=!0,dataChannel=!0;this._log(this.LOG_LEVEL.TRACE,"- Provided init options: ",options),"string"==typeof options?(apiKey=options,defaultRoom=apiKey,room=apiKey):(apiKey=options.apiKey,roomServer=options.roomServer||roomServer,roomServer=roomServer.lastIndexOf("/")===roomServer.length-1?roomServer.substring(0,roomServer.length-1):roomServer,region=options.region||region,defaultRoom=options.defaultRoom||apiKey,room=defaultRoom,iceTrickle="boolean"==typeof options.iceTrickle?options.iceTrickle:iceTrickle,dataChannel="boolean"==typeof options.dataChannel?options.dataChannel:dataChannel,options.credentials&&(startDateTime=options.credentials.startDateTime||(new Date).toISOString(),duration=options.credentials.duration||200,credentials=options.credentials.credentials)),this._readyState=0,this._trigger("readyStateChange",this.READY_STATE_CHANGE.INIT),this._apiKey=apiKey,this._roomServer=roomServer,this._defaultRoom=defaultRoom,this._selectedRoom=room,this._serverRegion=region,this._enableIceTrickle=iceTrickle,this._enableDataChannel=dataChannel,this._path=roomServer+"/api/"+apiKey+"/"+room,credentials&&(this._roomStart=startDateTime,this._roomDuration=duration,this._roomCredentials=credentials,this._path+=credentials?"/"+startDateTime+"/"+duration+"?&cred="+credentials:""),region&&(this._path+=(this._path.indexOf("?&")>-1?"&":"?&")+"rg="+region),this._log(this.LOG_LEVEL.TRACE,"- Init configuration: ",{serverUrl:this._path,readyState:this._readyState,apiKey:this._apiKey,roomServer:this._roomServer,defaultRoom:this._defaultRoom,selectedRoom:this._selectedRoom,serverRegion:this._serverRegion,enableDataChannel:this._enableDataChannel,enableIceTrickle:this._enableIceTrickle}),this._loadInfo()},Skyway.prototype.getUserMedia=function(options){var self=this,getStream=!1;if(options=options||{audio:!0,video:!0},self._user=self._user||{},self._user.info=self._user.info||{},self._user.info.settings=self._user.info.settings||{},self._user.streams=self._user.streams||[],self._user.info.settings?options.video||options.audio?(self._user.info.settings.audio!==options.audio||self._user.info.settings.video!==options.video)&&(Object.keys(self._user.streams).length>0?(getStream=self._setLocalMediaStreams(options),getStream&&(self._user.streams=[])):getStream=!0):self._log(self.LOG_LEVEL.INFO,"- No audio or video stream is requested"):getStream=!0,self._parseStreamSettings(options),getStream)try{window.getUserMedia({audio:self._streamSettings.audio,video:self._streamSettings.video},function(stream){self._onUserMediaSuccess(stream)},function(error){self._onUserMediaError(error)})}catch(error){self._onUserMediaError(error)}else Object.keys(self._user.streams).length>0?self._log(self.LOG_LEVEL.TRACE,"- <<MediaStream>> User has already this mediastream. Reactiving media"):self._log(self.LOG_LEVEL.WARN,"- <<MediaStream>> Not retrieving stream.")},Skyway.prototype.joinRoom=function(room,mediaOptions){var self=this;if(self._inRoom&&"string"!=typeof room||"string"==typeof room&&room===this._selectedRoom)return void self._log(self.LOG_LEVEL.ERROR,"- ("+("string"==typeof room?room:self._selectedRoom)+") Unable to join room as user is currently in the room already");self._log(self.LOG_LEVEL.TRACE,"- ("+self._selectedRoom+") Joining room. Media options: ",mediaOptions||("object"==typeof room?room:{}));var sendJoinRoomMessage=function(){self._sendChannelMessage({type:self._SIG_MESSAGE_TYPE.JOIN_ROOM,uid:self._user.id,cid:self._key,rid:self._room.id,userCred:self._user.token,timeStamp:self._user.timeStamp,apiOwner:self._user.apiOwner,roomCred:self._room.token,start:self._room.start,len:self._room.len})},doJoinRoom=function(){var checkChannelOpen=setInterval(function(){self._channelOpen?(clearInterval(checkChannelOpen),self._waitForLocalMediaStream(function(){sendJoinRoomMessage()},mediaOptions)):self._readyState===self.READY_STATE_CHANGE.COMPLETED&&self._openChannel()},500)};"string"==typeof room?self._reInitAndLoadInfo({room:room},doJoinRoom):(mediaOptions=room,doJoinRoom())},Skyway.prototype.leaveRoom=function(){if(!this._inRoom)return void this._log(this.LOG_LEVEL.ERROR,"- Unable to leave room as user is not in any room");for(var pc_index in this._peerConnections)this._peerConnections.hasOwnProperty(pc_index)&&this._removePeer(pc_index);this._inRoom=!1,this._closeChannel(),this._log(this.LOG_LEVEL.TRACE,"- ("+this._selectedRoom+") User left the room"),this._trigger("peerLeft",this._user.sid,this._user.info,!0)},Skyway.prototype.sendMessage=function(message,targetPeerId){var params={cid:this._key,data:message,mid:this._user.sid,rid:this._room.id,type:this._SIG_MESSAGE_TYPE.PUBLIC_MESSAGE};targetPeerId&&(params.target=targetPeerId,params.type=this._SIG_MESSAGE_TYPE.PRIVATE_MESSAGE),this._log(this.LOG_LEVEL.TRACE,(targetPeerId?" ["+targetPeerId+"]":"")+" - Sending message to peer"+(targetPeerId?"s":"")),this._sendChannelMessage(params),this._trigger("incomingMessage",{content:message,isPrivate:targetPeerId?!0:!1,targetPeerId:targetPeerId||null,isDataChannel:!1,senderPeerId:this._user.sid},this._user.sid,this._user.info,!0)},Skyway.prototype.sendBlobData=function(data,dataInfo,targetPeerId){if(!data&&!dataInfo)return!1;var noOfPeersSent=0;if(dataInfo.timeout=dataInfo.timeout||60,dataInfo.transferId=this._user.sid+this.DATA_TRANSFER_TYPE.UPLOAD+(new Date).toISOString().replace(/-/g,"").replace(/:/g,"").replace(".",""),targetPeerId)this._dataChannels.hasOwnProperty(targetPeerId)?(this._log(this.LOG_LEVEL.TRACE,"["+targetPeerId+"] Sending blob data -> ",dataInfo),this._sendBlobDataToPeer(data,dataInfo,targetPeerId),noOfPeersSent=1):this._log(this.LOG_LEVEL.ERROR,"["+targetPeerId+"] Datachannel does not exist");else{targetpeerId=this._user.sid;
for(var peerId in this._dataChannels)this._dataChannels.hasOwnProperty(peerId)?(this._sendBlobDataToPeer(data,dataInfo,peerId),noOfPeersSent++):this._log(this.LOG_LEVEL.ERROR,"["+peerId+"] Datachannel does not exist")}if(noOfPeersSent>0)this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.UPLOAD_STARTED,dataInfo.transferId,targetPeerId,{transferId:dataInfo.transferId,senderPeerId:this._user.sid,name:dataInfo.name,size:dataInfo.size,timeout:dataInfo.timeout||60,data:data});else{var error="No available datachannels to send data.";this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.ERROR,transferId,targetPeerId,null,{message:error,transferType:this.DATA_TRANSFER_TYPE.UPLOAD}),this._log(this.LOG_LEVEL.ERROR,"- Failed sending data: ",error),this._uploadDataTransfers=[],this._uploadDataSessions=[]}},Skyway.prototype.respondBlobRequest=function(peerId,accept){if(accept){this._log(this.LOG_LEVEL.INFO,"["+peerId+"] - User accepted peer's request"),this._downloadDataTransfers[peerId]=[];var data=this._downloadDataSessions[peerId];this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.ACK,sender:this._user.sid,ackN:0,agent:window.webrtcDetectedBrowser}),this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.DOWNLOAD_STARTED,data.transferId,peerId,{name:data.name,size:data.size,senderPeerId:peerId})}else this._log(this.LOG_LEVEL.INFO,"["+peerId+"] - User rejected peer's request"),this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.ACK,sender:this._user.sid,ackN:-1}),delete this._downloadDataSessions[peerId]},Skyway.prototype.cancelBlobTransfer=function(peerId){if(accept){this._downloadDataTransfers[peerId]=[];var data=this._downloadDataSessions[peerId];this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.ACK,sender:this._user.sid,ackN:0,agent:window.webrtcDetectedBrowser}),this._trigger("dataTransferState",this.DATA_TRANSFER_STATE.CANCEL,data.transferId,peerId,{name:data.name,size:data.size,senderPeerId:peerId})}else this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.ACK,sender:this._user.sid,ackN:-1}),delete this._downloadDataSessions[peerId]},Skyway.prototype.sendP2PMessage=function(message,targetPeerId){for(var peerId in this._dataChannels)this._dataChannels.hasOwnProperty(peerId)&&(targetPeerId&&targetPeerId===peerId||!targetPeerId)&&(this._log(this.LOG_LEVEL.TRACE,"["+peerId+"] - Sending P2P message to peer"),this._sendDataChannelMessage(peerId,{type:this._DC_PROTOCOL_TYPE.MESSAGE,isPrivate:!!targetPeerId,sender:this._user.sid,target:targetPeerId,data:message}));this._trigger("incomingMessage",{content:message,isPrivate:targetPeerId?!0:!1,targetPeerId:targetPeerId||null,isDataChannel:!0,senderPeerId:this._user.sid},this._user.sid,this._user.info,!0)},Skyway.prototype.setUserData=function(userData){var self=this;if(self._readyState===self.READY_STATE_CHANGE.COMPLETED)self._user.info=self._user.info||{},self._user.info.userData=userData||self._user.info.userData||{},self._inRoom?(self._log(self.LOG_LEVEL.TRACE,"- Updated userData -> ",userData),self._sendChannelMessage({type:self._SIG_MESSAGE_TYPE.UPDATE_USER,mid:self._user.sid,rid:self._room.id,userData:self._user.info.userData}),self._trigger("peerUpdated",self._user.sid,self._user.info,!0)):self._log(self.LOG_LEVEL.WARN,"- User is not in the room. Broadcast of updated information will be dropped");else var checkInRoom=setInterval(function(){self._readyState===self.READY_STATE_CHANGE.COMPLETED&&(clearInterval(checkInRoom),self.setUserData(userData))},50)},Skyway.prototype.getUserData=function(){return this._user&&this._user.info?this._user.info.userData||"":""},Skyway.prototype.getPeerInfo=function(peerId){return peerId&&peerId!==this._user.sid?this._peerInformations[peerId]:this._user?this._user.info:null},Skyway.prototype.lockRoom=function(){this._log(this.LOG_LEVEL.TRACE,"- Update to isRoomLocked status -> ",!0),this._sendChannelMessage({type:this._SIG_MESSAGE_TYPE.ROOM_LOCK,mid:this._user.sid,rid:this._room.id,lock:!0}),this._trigger("roomLock",!0,this._user.sid,this._user.info,!0)},Skyway.prototype.unlockRoom=function(){this._log(this.LOG_LEVEL.TRACE,"- Update to isRoomLocked status -> ",!1),this._sendChannelMessage({type:this._SIG_MESSAGE_TYPE.ROOM_LOCK,mid:this._user.sid,rid:this._room.id,lock:!1}),this._trigger("roomLock",!1,this._user.sid,this._user.info,!0)},Skyway.prototype.enableAudio=function(){this._handleLocalMediaStreams("audio",!0)},Skyway.prototype.disableAudio=function(){this._handleLocalMediaStreams("audio",!1)},Skyway.prototype.enableVideo=function(){this._handleLocalMediaStreams("video",!0)},Skyway.prototype.disableVideo=function(){this._handleLocalMediaStreams("video",!1)}}).call(this);